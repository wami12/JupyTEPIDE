...
*/
    ...
    function Yb(a, b, c, d) {
        a = Zb(a);
        var e = a.j;
        e ? b = e(b, c) : "degrees" == a.a && !d || "degrees" == d || (e = $b(a, Zb("EPSG:4326")), b = [c[0] - b / 2, c[1], c[0] + b / 2, c[1], c[0], c[1] - b / 2, c[0], c[1] + b / 2], b = e(b, b, 2), b = (Wb.b(b.slice(0, 2), b.slice(2, 4)) + Wb.b(b.slice(4, 6), b.slice(6, 8))) / 2, a = d ? Eb[d] : a.Rc(), void 0 !== a && (b /= a));
        return b
    }
    ...
    k.Ja = function (a, b) {
        var c = this.Cc(a[0]), d = this.Qa(a[0]), e = Na(this.eb(a[0]), this.g), f = c[0] + a[1] * e[0] * d;
        a = c[1] + a[2] * e[1] * d;
    ...
    k.Me = function (a, b, c) {
        var d = a[0], e = a[1];
        a = this.xc(b);
        var f = b / this.Qa(a), g = this.Cc(a), h = Na(this.eb(a), this.g);
    ...
    function Gc(a) {
        function b(b) {
            var c = a.listener, e = a.zh || a.target;
            a.Bh && Hc(a);
            return c.call(e, b)
        }
    ...
    function Ic(a, b, c, d) {
        for (var e, f = 0, g = a.length; f < g; ++f) if (e = a[f], e.listener === b && e.zh === c) return d && (e.deleteIndex = f), e
    }
    ...
    function Lc(a, b) {
        var c = Jc(a, b);
        if (c) {
            for (var d = 0, e = c.length; d < e; ++d) a.removeEventListener(b, c[d].Ah), ub(c[d]);
            c.length = 0;
    ...
    Tc.prototype.b = function (a) {
        ...
        var c = this.ra[a];
        if (c) {
            a in this.sa || (this.sa[a] = 0, this.Ua[a] = 0);
            ++this.sa[a];
            for (var d = 0, e = c.length; d < e; ++d) if (!1 === c[d].call(this, b) || b.yp) {
                var f = !1;
                break
            }
            --this.sa[a];
    ...
    Tc.prototype.removeEventListener = function (a, b) {
        var c = this.ra[a];
        c && (b = c.indexOf(b), a in this.Ua ? (c[b] = sa, ++this.Ua[a]) : (c.splice(b, 1), 0 === c.length && delete this.ra[a]))
    };
    ...
    k.remove = function (a) {
        var b = this.a, c;
        var d = 0;
        for (c = b.length; d < c; ++d) if (b[d] === a) return this.Ug(d)
    };
    k.Ug = function (a) {
        var b = this.a[a];
        this.a.splice(a, 1);
    ...
    function hd(a, b) {
        var c, d, e = gd.length;
        for (d = 0; d < e; ++d) try {
            if (c = a.getContext(gd[d], b)) return c
        } catch (f) {
        }
        return null
    }
    ...
    var id, jd = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
        ...
        pd = window.devicePixelRatio || 1, qd = !1, rd = function () {
            ...
            try {
                ...
                return a ? (void 0 !== a.setLineDash && (qd = !0), !0) : !1
            } catch (b) {
                return !1
            }
    ...
    if ("WebGLRenderingContext" in window) try {
        ...
        Bd && (yd = !0, zd = Bd.getParameter(Bd.MAX_TEXTURE_SIZE), Ad = Bd.getSupportedExtensions())
    } catch (a) {
    }
    id = yd;
    da = Ad;
    ...
    function Hd(a) {
        var b = Id(a, a), c = b.preventDefault;
    ...
    k.tm = function (a) {
        if (!Gd(this, a)) {
            ...
            b && b.button === a.button && (b = Hd(a), Jd(this.b, "pointerup", b, a), delete this.a[(1).toString()])
        }
    };
    k.sm = function (a) {
        if (!Gd(this, a)) {
    ...
    function Nd(a, b) {
        var c = b;
        "number" === typeof b.pointerType && (c = Id(b, b), c.pointerType = a.f[b.pointerType]);
        return c
    }
    ...
    function Rd(a) {
        if (a.buttons || Td) a = a.buttons; else switch (a.which) {
            case 1:
                a = 1;
                break;
            case 2:
    ...
    k.uq = function (a) {
        ...
        if (d >= b.length) {
            ...
            for (f = 0; f < e.length; ++f) this.Of(a, e[f])
        }
    ...
    k.lp = function (a, b) {
        this.a[b.pointerId] = {target: b.target, out: b, jj: b.target};
        var c = this.b;
        b.bubbles = !0;
    ...
    k.um = function (a, b) {
        ...
        if (c) {
            var d = c.out, e = c.jj;
            Jd(this.b, "pointermove", b, a);
            d && e !== b.target && (d.relatedTarget = b.target, b.relatedTarget = e, d.target = e, b.target ? (Ld(this.b, d, a), Kd(this.b, b, a)) : (b.target = e, b.relatedTarget = null, this.Of(a, b)));
            c.out = b;
            c.jj = b.target
        }
    };
    ...
    k.vq = function (a, b) {
        ...
        b.isPrimary && (this.f = void 0, this.c = setTimeout(this.wj.bind(this), 200))
    };
    k.rq = function (a) {
        Wd(this, a, this.Of)
    };
    ...
    function Zd(a) {
        ...
        this.i = {};
        this.a = [];
        vd ? $d(this, new Pd(this)) : wd ? $d(this, new Md(this)) : (a = new Fd(this), $d(this, a), ud && $d(this, new Ud(this, a)));
        a = this.a.length;
        for (var b, c = 0; c < a; c++) b = this.a[c], ae(this, Object.keys(b.i))
    }
    ...
    function Id(a, b) {
        for (var c = {}, d, e = 0, f = ce.length; e < f; e++) d = ce[e][0], c[d] = a[d] || b[d] || ce[e][1];
        return c
    }
    ...
    function Kd(a, b, c) {
        ...
        var d = b.target, e = b.relatedTarget;
        d && e && d.contains(e) || (b.bubbles = !1, Jd(a, "pointerenter", b, c))
    }
    ...
    Zd.prototype.ka = function () {
        for (var a = this.a.length, b, c = 0; c < a; c++) b = this.a[c], be(this, Object.keys(b.i));
    ...
    function ee(a, b) {
        ...
        a.b(c);
        0 !== a.j ? (clearTimeout(a.j), a.j = 0, c = new Dd("dblclick", a.f, b), a.b(c)) : a.j = setTimeout(function () {
            this.j = 0;
    ...
    k.Wl = function (a) {
        ...
        this.b(b);
        this.c = a;
        0 === this.i.length && (this.a = new Zd(document), this.i.push(z(this.a, "pointermove", this.Sm, this), z(this.a, "pointerup", this.$h, this), z(this.g, "pointercancel", this.$h, this)))
    };
    k.Sm = function (a) {
        if (ge(this, a)) {
            this.l = !0;
    ...
    function ie(a) {
        ...
        1 == b.length ? (b.length = 0, c.length = 0) : (b[0] = b.pop(), c[0] = c.pop(), je(a, 0));
        b = a.c(d);
        delete a.a[b];
        return d
    }
    ...
    he.prototype.i = function (a) {
        ...
        var b = this.o(a);
        return Infinity != b ? (this.b.push(a), this.f.push(b), this.a[this.c(a)] = !0, ke(this, 0, this.b.length - 1), !0) : !1
    };
    ...
    me.prototype.l = function (a) {
        a = a.target;
        var b = a.getState();
        if (2 === b || 3 === b || 4 === b || 5 === b) Nc(a, "change", this.l, this), a = a.gb(), a in this.g && (delete this.g[a], --this.j), this.v()
    };
    ...
    k.Zd = function (a) {
        this.l != this.f && (ub(this.i), this.g = 0, this.l = this.f);
    ...
    k.translate = function (a, b) {
        var c = this.ca();
        c && (Se(c, 0, c.length, this.pa(), a, b, c), this.u())
    };
    ...
    function rf(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        for (var q = n ? n : [NaN, NaN], r = b + d; r < c;) if (of(a, r - d, r, d, g, h, q), p = Ha(g, h, q[0], q[1]), p < m) {
            m = p;
            for (n = 0; n < d; ++n) l[n] = q[n];
            l.length = d;
            r += d
        } else r += d * Math.max((Math.sqrt(p) - Math.sqrt(m)) / e | 0, 1);
        if (f && (of(a, c - d, b, d, g, h, q), p = Ha(g, h, q[0], q[1]), p < m)) {
            m = p;
            for (n = 0; n < d; ++n) l[n] = q[n];
            l.length = d
        }
    ...
    k.Mb = function (a, b, c, d) {
        ...
        this.c != this.f && (this.j = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0)), this.c = this.f);
    ...
    k.na = function (a, b) {
        a ? (jf(this, b, a, 1), this.A || (this.A = []), this.A.length = uf(this.A, 0, a, this.a), this.u()) : Cf(this, "XY", null)
    };
    ...
    k.na = function (a, b) {
        a ? (jf(this, b, a, 0), this.A || (this.A = []), this.A.length = tf(this.A, a), this.u()) : this.aa("XY", null)
    };
    k.aa = function (a, b) {
        hf(this, a, b);
        this.u()
    ...
    function Ff(a, b, c, d, e, f) {
        if (0 === c.length || !Ef(a, b, c[0], d, e, f)) return !1;
        var g;
        b = 1;
    ...
    function Gf(a, b, c, d, e, f, g) {
        ...
        for (u = m.length; h < u; ++h) {
            r = m[h];
            var x = Math.abs(r - p);
            x > q && (p = (p + r) / 2, Ff(a, b, c, d, p, l) && (n = p, q = x));
            p = r
        }
        isNaN(n) && (n = e[f]);
    ...
    function Jf(a, b, c, d, e) {
        var f = c[0];
        if (!(If(a, b, f, d, e) || Ef(a, b, f, d, e[0], e[1]) || Ef(a, b, f, d, e[0], e[3]) || Ef(a, b, f, d, e[2], e[1]) || Ef(a, b, f, d, e[2], e[3]))) return !1;
    ...
    k.Mb = function (a, b, c, d) {
        if (d < Ta(this.G(), a, b)) return d;
        this.D != this.f && (this.B = Math.sqrt(qf(this.A, 0, this.c, this.a, 0)), this.D = this.f);
    ...
    k.Ub = function () {
        if (this.I != this.f) {
            var a = this.A;
            Lf(a, this.c, this.a) ? this.j = a : (this.j = a.slice(), this.j.length = Mf(this.j, 0, this.c, this.a));
            this.I = this.f
        }
        return this.j
    };
    ...
    k.na = function (a, b) {
        a ? (jf(this, b, a, 2), this.A || (this.A = []), a = vf(this.A, 0, a, this.a, this.c), this.A.length = 0 === a.length ? 0 : a[a.length - 1], this.u()) : this.aa("XY", null, this.c)
    };
    k.aa = function (a, b, c) {
        hf(this, a, b);
        this.c = c;
    ...
    function Tf(a, b, c, d) {
        var e = a.ca(), f = a.ja, g = a.pa(), h = a.lb(), l = e.length / g - 1;
        d = d ? d : 0;
    ...
    function Uf(a, b) {
        ...
        a.j = b.resolutions;
        a.o = d;
        (void 0 !== b.enableRotation ? b.enableRotation : 1) ? (d = b.constrainRotation, d = void 0 === d || !0 === d ? ve() : !1 === d ? te : "number" === typeof d ? ue(d) : te) : d = se;
        a.g = {center: void 0 !== b.extent ? oe(b.extent) : pe, resolution: e, rotation: d};
    ...
    k.animate = function (a) {
        ...
        if (Wf(this)) {
            for (var d = Date.now(), e = this.xa().slice(), f = this.Oa(), g = this.Pa(), h = [], l = 0; l < b; ++l) {
                ...
                m.center && (n.le = e, n.pe = m.center, e = n.pe);
                void 0 !== m.zoom ? (n.ne = f, n.dd = this.constrainResolution(this.a, m.zoom - this.o, 0), f = n.dd) : m.resolution && (n.ne = f, n.dd = m.resolution, f =
                    n.dd);
                void 0 !== m.rotation && (n.Df = g, n.qe = g + (Ja(m.rotation - g + Math.PI, 2 * Math.PI) - Math.PI), g = n.qe);
                n.callback = c;
            ...
            Xf(this, 0, 1);
            this.Ff()
        } else b = arguments[b - 1], b.center && this.rb(b.center), void 0 !== b.zoom && this.Lj(b.zoom), void 0 !== b.rotation && this.de(b.rotation), c && c(!0)
    };
    k.Pc = function () {
        return 0 < Yf(this)[0]
    };
            ...
            for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
                for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
                    ...
                    if (!h.complete) {
                        ...
                        h.ne && h.dd && (l = 1 === b ? h.dd : h.ne + b * (h.dd - h.ne), h.anchor && this.set("center", Zf(this, l, h.anchor)), this.set("resolution",
                            l));
                        void 0 !== h.Df && void 0 !== h.qe && (b = 1 === b ? Ja(h.qe + Math.PI, 2 * Math.PI) - Math.PI : h.Df + b * (h.qe - h.Df), h.anchor && this.set("center", $f(this, b, h.anchor)), this.set("rotation", b));
                        b = !0;
                        if (!h.complete) break
                    }
                }
                e && (this.c[c] = null, Xf(this, 0, -1), (d = d[0].callback) && d(!0))
            }
    ...
    k.iq = function (a) {
        Uf(this, Vf(this, {maxZoom: a}))
    };
    k.$m = function () {
        return this.Ne(this.a)
    };
    k.jq = function (a) {
        Uf(this, Vf(this, {minZoom: a}))
    };
    k.an = function () {
        return this.v
    };
    ...
    k.getState = function () {
        var a = this.xa(), b = this.v, c = this.Oa(), d = this.Pa();
    ...
    k.Uf = function (a, b) {
        ...
        var c = b.size;
        c || (c = ag(this));
        if (a instanceof ff) if ("Circle" === a.S()) {
            a = a.G();
            var d = Rf(a);
            d.rotate(this.Pa(), nb(a))
        } else d = a; else wa(Array.isArray(a), 24), wa(!kb(a), 25), d = Rf(a);
        ...
        }, e) : (this.ad(c), this.rb(a), setTimeout(e.bind(void 0, !0), 0))
    };
    k.Fk = function (a, b, c) {
    ...
    k.rotate = function (a, b) {
        void 0 !== b && (b = $f(this, a, b), this.rb(b));
        this.de(a)
    };
    k.rb = function (a) {
        this.set("center", a);
    ...
    function ig(a) {
        ...
        b ? Array.isArray(b) ? b = new C(b.slice(), {unique: !0}) : wa(b instanceof C, 43) : b = new C(void 0, {unique: !0});
        this.Ni(b)
    }
    ...
    function G(a) {
        ...
        for (var c = "click dblclick mousedown touchstart MSPointerDown pointerdown mousewheel wheel".split(" "), d = 0, e = c.length; d < e; ++d) z(this.v, c[d], Sc);
        this.a.appendChild(this.v);
        this.fa = new de(this, a.moveTolerance);
        for (var f in Cd) z(this.fa, Cd[f], this.Zh, this);
    ...
    k.Mc = function (a, b, c) {
        if (this.c) return a = this.Na(a), c = c ? c : {}, this.lc.Fa(a, this.c, void 0 !== c.hitTolerance ? c.hitTolerance * this.c.pixelRatio : 0, b, null, c.layerFilter ? c.layerFilter : Pe, null)
    };
    k.Yf = function (a, b) {
        var c = null;
    ...
    k.sg = function (a, b, c, d, e) {
        if (this.c) return this.lc.Qi(a, this.c, b, void 0 !== c ? c : null, d ? d : Pe, void 0 !== e ? e : null)
    };
    k.ng = function (a, b) {
        if (!this.c) return !1;
        a = this.Na(a);
    ...
    k.zl = function (a, b, c, d) {
        var e = this.c;
        if (!(e && b in e.wantedTiles && e.wantedTiles[b][a.gb()])) return Infinity;
        a = c[0] - e.focus[0];
        c = c[1] - e.focus[1];
    ...
    k.Zl = function () {
        var a = this.c, b = this.ma;
        if (0 !== b.b.length) {
            var c = 16, d = c;
            if (a) {
                var e = a.viewHints;
                e[0] && (c = this.ub ? 8 : 0, d = 2);
                e[1] && (c = this.Lb ? 8 : 0, d = 2)
            }
            b.j < c && (le(b), ne(b, c, d))
        }
        b = this.oa;
    ...
    k.em = function () {
        ...
        a ? (a.appendChild(this.a), a = this.ta ? this.ta : a, this.o = [z(a, "keydown", this.sd, this), z(a, "keypress", this.sd, this)], this.i || (this.i = this.Gc.bind(this), window.addEventListener("resize", this.i, !1))) : (fg(this.a), this.i && (window.removeEventListener("resize", this.i, !1), this.i = void 0));
        this.Gc()
    };
    k.fm = function () {
        this.render()
    ...
    k.gm = function () {
        ...
        var a = this.$();
        a && (this.a.setAttribute("data-view", w(a)), this.B = z(a, "propertychange", this.bi, this), this.D = z(a, "change", this.bi, this));
        this.render()
    };
    k.Ml = function () {
    ...
    k.Wp = function (a) {
        ...
        this.c = g;
        this.lc.$g(g);
        g && (g.animate && this.render(), Array.prototype.push.apply(this.oa, g.postRenderFunctions), !f || this.g && (kb(this.g) || cb(g.extent, this.g)) || (this.b(new ed("movestart", this, f)), this.g = Za(this.g)), !this.g || g.viewHints[0] || g.viewHints[1] || cb(g.extent, this.g) || (this.b(new ed("moveend", this, g)), Sa(g.extent, this.g)));
    ...
    function og(a) {
        ...
        e = a.layers instanceof ig ? a.layers : new ig({layers: a.layers});
        c.layergroup = e;
        c.target = a.target;
        c.view = void 0 !== a.view ? a.view : new F;
        var f;
        void 0 !== a.renderer ? (Array.isArray(a.renderer) ? f = a.renderer : "string" === typeof a.renderer ? f = [a.renderer] : wa(!1, 46), 0 <= f.indexOf("dom") && (f = f.concat(pg))) : f = pg;
        e = 0;
        var g =
            f.length;
        a:for (; e < g; ++e) for (var h = f[e], l = 0, m = kg.length; l < m; ++l) {
            var n = kg[l];
            if (n.handles(h)) {
                var p = n;
                break a
        ...
        if (void 0 !== a.controls) if (Array.isArray(a.controls)) var q = new C(a.controls.slice()); else wa(a.controls instanceof C, 47), q = a.controls;
        if (void 0 !== a.interactions) if (Array.isArray(a.interactions)) var r = new C(a.interactions.slice()); else wa(a.interactions instanceof C, 48), r = a.interactions;
    ...
    function sg(a) {
        if (a = a.frameState) {
            ...
            p = b[0];
            b = b[1];
            for (var U in this.o) U in p ? (this.j[U] || (this.o[U].style.display = "", this.j[U] = !0), delete p[U]) : U in b ? (this.j[U] && (this.o[U].style.display = "none", delete this.j[U]), delete b[U]) : (fg(this.o[U]), delete this.o[U], delete this.j[U]);
            for (U in p) r =
            ...
            a = a.logos;
            U = this.U;
            for (Ca in U) Ca in a || (fg(U[Ca]), delete U[Ca]);
    ...
    k.gn = function (a) {
        this.l !== a && (this.l = a, this.element.classList.toggle("ol-uncollapsible"), !a && this.c && tg(this))
    };
    k.fn = function (a) {
    ...
    function ug(a) {
        ...
        qg.call(this, {element: d, render: b, target: a.target});
    ...
    function wg(a) {
        ...
        z(h, "click", wg.prototype.j.bind(this,
            c));
        d = document.createElement("button");
        d.className = b + "-out";
        d.setAttribute("type", "button");
        ...
        c.appendChild(h);
        c.appendChild(d);
        qg.call(this, {element: c, target: a.target});
    ...
    wg.prototype.j = function (a, b) {
        ...
        if (b = this.a.$()) {
            var c = b.Oa();
            c && (a = b.constrainResolution(c, a), 0 < this.c ? (b.Pc() && b.kd(), b.animate({
                resolution: a,
                duration: this.c,
                easing: Me
            })) : b.ad(a))
    ...
    function Eg(a, b, c, d) {
        if (void 0 !== b) {
            var e = a.Pa(), f = a.xa();
            void 0 !== e && f && 0 < d ? a.animate({rotation: b, anchor: c, duration: d, easing: Me}) : a.rotate(b, c)
        }
    }
    ...
    function Tg(a) {
        a = a ? a : {};
        Bg.call(this, {handleEvent: a.handleEvent ? a.handleEvent : Ug});
    ...
    function Ug(a) {
        ...
        this.C ? "pointerdrag" == a.type ? this.wk(a) : "pointerup" == a.type && (this.C = this.Dk(a) && 0 < this.l.length) : "pointerdown" == a.type ? (this.C = a = this.Vj(a), b = this.cd(a)) : "pointermove" == a.type && this.Ck(a);
        return !b
    }
    ...
    function Wg(a) {
        Tg.call(this, {handleDownEvent: Xg, handleDragEvent: Yg, handleUpEvent: Zg});
        a = a ? a : {};
        this.a = a.kinetic;
        this.g = null;
    ...
    function Zg(a) {
        ...
        if (0 === this.l.length) {
            if (!this.j && this.a && Ag(this.a)) {
                ...
                a.animate({center: a.Kc(b), duration: 500, easing: Me})
            }
            Xf(a, 1, -1);
            return !1
        }
    ...
    function $g(a) {
        a = a ? a : {};
        Tg.call(this, {handleDownEvent: ah, handleDragEvent: bh, handleUpEvent: ch});
    ...
    function ah(a) {
        return Rg(a) && Lg(a) && this.g(a) ? (Xf(a.map.$(), 1, 1), this.a = void 0, !0) : !1
    }
    ...
    function gh(a) {
        Tg.call(this, {handleDownEvent: hh, handleDragEvent: ih, handleUpEvent: jh});
        a = a ? a : {};
    ...
    function jh(a) {
        if (!Rg(a)) return !0;
        this.a.setMap(null);
        this.o(a, this.g, a.pixel) && (this.j(a), this.b(new lh(nh, a.coordinate, a)));
        return !1
    }
    ...
    var oh = "boxstart", mh = "boxdrag", nh = "boxend";
    ...
    function ph(a) {
        ...
        gh.call(this, {condition: b, className: a.className || "ol-dragzoom"})
    }

    v(ph, gh);
    ph.prototype.j = function () {
        var a = this.v, b = a.$(), c = a.zb(), d = this.W().G();
        if (this.I) {
            var e = b.jd(c);
        ...
        e = nb(d);
        e = b.Kc(e);
        b.animate({resolution: c, center: e, duration: this.B, easing: Me})
    };

    function qh(a) {
        Bg.call(this, {handleEvent: rh});
        a = a || {};
        this.a = function (a) {
            return Og(a) && Qg(a)
        };
    ...
    function rh(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.g(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
                ...
                Ee(d, b.Pa());
                c = this.j;
                if (e = b.xa()) d = b.Kc([e[0] + d[0], e[1] + d[1]]), c ? b.animate({
                    duration: c,
                    easing: Oe,
                    center: d
                }) : b.rb(d);
    ...
    function wh(a) {
        ...
        } else "mousewheel" == a.type && (d = -c.wheelDeltaY, ld && (d /= 3));
        if (0 === d) return !1;
        a = Date.now();
        void 0 === this.g && (this.g = a);
        if (!this.l || 400 < a - this.g) this.l = 4 > Math.abs(d) ? xh : yh;
        if (this.l === xh) {
            b = b.$();
            ...
            0 < g ? b.animate({
                ...
                anchor: this.a,
                duration: 500
            }) : 0 > g && b.animate({resolution: f, easing: Me, anchor: this.a, duration: 500});
            this.g = a;
            return !1
        }
        this.j += d;
    ...
    function Bh(a) {
        ...
        if (c.g.rotation !== se) {
            ...
            e[1] -= d.top;
            this.g = a.Na(e);
            this.a && (d = c.Pa(), a.render(), Eg(c, d + b, this.g))
        }
    }
    ...
    function Ah(a) {
        return 2 <= this.l.length ? (a = a.map, this.g = null, this.j = void 0, this.a = !1, this.o = 0, this.C || Xf(a.$(), 1, 1), !0) : !1
    }

    zh.prototype.cd = Qe;

    function Dh(a) {
        Tg.call(this, {handleDownEvent: Eh, handleDragEvent: Fh, handleUpEvent: Gh});
        a = a ? a : {};
    ...
    function Eh(a) {
        return 2 <= this.l.length ? (a = a.map, this.g = null, this.a = void 0, this.j = 1, this.C || Xf(a.$(), 1, 1), !0) : !1
    }
    ...
    function Hh(a) {
        a = a ? a : {};
        var b = new C, c = new yg(-.005, .05, 100);
        ...
        (void 0 !== a.dragPan ? a.dragPan : 1) && b.push(new Wg({kinetic: c}));
        ...
        if (void 0 !== a.keyboard ?
                a.keyboard : 1) b.push(new qh), b.push(new th({delta: a.zoomDelta, duration: a.zoomDuration}));
    ...
    var Qh = function () {
        ...
        return function (c) {
            if (a.hasOwnProperty(c)) var d = a[c]; else {
                ...
                d = c;
                Oh.exec(d) && (e = document.createElement("div"), e.style.color = d, document.body.appendChild(e), d = getComputedStyle(e).color, document.body.removeChild(e));
                if (Nh.exec(d)) {
                    var f = d.length - 1;
                    wa(3 == f || 6 == f, 54);
                    var g = 3 == f ? 1 : 2;
                    ...
                    1 == g && (f = (f << 4) + f, e = (e << 4) + e, d = (d <<
                        4) + d);
                    f = [f, e, d, 1]
                } else 0 == d.indexOf("rgba(") ? (d = d.slice(5, -1).split(",").map(Number), f = Sh(d)) : 0 == d.indexOf("rgb(") ? (d = d.slice(4, -1).split(",").map(Number), d.push(1), f = Sh(d)) : wa(!1, 14);
                d = f;
                a[c] = d;
                ++b
            }
    ...
    function Wh(a, b, c) {
        if (a.N) {
            ...
            for (g = b.length; h < g; h += 2) {
                ...
                a.ma && (l = Math.round(l), m = Math.round(m));
                if (0 !== f || 1 != a.i) {
                    var n = l + a.C, p = m + a.D;
    ...
    function Xh(a, b, c, d) {
        ...
        if (a.sa && "" !== a.qa) {
            a.j && Yh(a, a.j);
            a.o && Zh(a, a.o);
            var f = a.sa, g = a.f, h = a.Ua, l = f.textAlign ? f.textAlign : "center";
    ...
    function ai(a, b, c, d, e) {
        var f;
        var g = 0;
        for (f = d.length; g < f; ++g) c = $h(a, b, c, d[g], e, !0);
        return c
    }
    ...
    k.Fe = function (a, b) {
        (a = (0, b.Za)(a)) && qb(this.c, a.G()) && (this.zd(b), this.Fb(a))
    };
    k.Ge = function (a) {
        a = a.a;
        var b;
        var c = 0;
        for (b = a.length; c < b; ++c) this.Fb(a[c])
    };
    k.uc = function (a) {
        var b = a.ca();
        a = a.pa();
    ...
    k.rc = function (a) {
        ...
        if (qb(this.c, b)) {
            if (this.b) {
                Zh(this, this.b);
                b = this.f;
                var c = a.ca(), d = 0, e = a.lb(), f = a.pa();
                b.beginPath();
                var g;
                var h = 0;
                for (g = e.length; h < g; ++h) d = $h(this, c, d, e[h], f, !1);
                b.stroke()
            }
            "" !== this.qa && (a = ci(a), Xh(this, a, a.length, 2))
        }
    };
    k.vc = function (a) {
        if (qb(this.c, a.G())) {
    ...
    k.tc = function (a) {
        if (qb(this.c, a.G())) {
            if (this.b || this.a) {
                ...
                b.beginPath();
                var h = 0;
                for (g = e.length; h < g; ++h) d = ai(this, c, d, e[h], f);
                this.a && b.fill();
                this.b && b.stroke()
            }
            "" !== this.qa && (a = ei(a), Xh(this, a, a.length, 2))
        }
    };
    ...
    function Zh(a, b) {
        var c = a.f, d = a.T;
        d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), qd && (ma(d.lineDash, b.lineDash) || c.setLineDash(d.lineDash = b.lineDash), d.lineDashOffset != b.lineDashOffset && (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)), d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth = c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) :
            (c.lineCap = b.lineCap, qd && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin, c.lineWidth = b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.T = {
                lineCap: b.lineCap,
                lineDash: b.lineDash,
    ...
    k.La = function (a, b) {
        a ? (a = a.b, this.a = {fillStyle: Th(a ? a : Jh)}) : this.a = null;
        if (b) {
            a = b.b;
    ...
    k.Wb = function (a) {
        if (a) {
            var b = a.Oc(), c = a.Y(1), d = a.Vc(), e = a.kc();
            this.C = b[0];
            this.D = b[1];
            this.B = e[1];
            this.N = c;
    ...
    k.ib = function (a) {
        if (a) {
            var b = a.Ca();
            b ? (b = b.b, this.j = {fillStyle: Th(b ? b : Jh)}) : this.j = null;
            var c = a.Da();
            if (c) {
                b = c.b;
    ...
    function ni(a, b, c, d, e, f, g, h, l, m) {
        ...
        for (u = c.minZoom; u <= g; ++u) {
            var x = tc(c, f, u, x);
            var B = c.Qa(u);
            for (q = x.ba; q <= x.da; ++q) for (r = x.ea; r <= x.ga; ++r) if (g - u <= h) {
                var A = b.Uc(u, q, r, d, e);
                0 == A.getState() && (p[A.gb()] = !0, A.gb() in a.a || a.i([A, n, yc(c, A.wa), B]));
                l && l.call(m, A)
            } else b.ih(u, q, r, e)
        }
    }
    ...
    oi.prototype.o = function (a, b, c, d) {
        if (this.Fa(a, b, 0, Pe, this)) return c.call(d, this.a, null)
    };
    ...
    si.prototype.o = function (a, b, c, d) {
        if (this.Y()) {
            if (this.a.ia().Fa !== sa) return oi.prototype.o.apply(this, arguments);
    ...
    k.Fa = function (a, b, c, d, e, f, g) {
        ...
        for (q = p.length - 1; 0 <= q; --q) {
            var u = p[q];
            r = u.layer;
            if (xi(u, n) && f.call(g, r) && (u = Di(this, r), r.ia() && (l = u.Fa(r.ia().C ? m : a, b, c, h, e)), l)) return l
        }
    };
    ...
    function Di(a, b) {
        ...
        if (d) a.c[c] = d, a.o[c] = z(d, "change", a.Nl, a); else throw Error("Unable to create renderer for layer: " + b.S());
        return d
    }
    ...
    Fi.prototype.Qi = function (a, b, c, d, e, f) {
        ...
        for (--l; 0 <= l; --l) {
            var m = h[l];
            var n = m.layer;
            if (xi(m, g) && e.call(f, n) && (m = Di(this, n).o(a, b, c, d))) return m
        }
    };
    ...
    Hi.prototype.Ad = function (a, b) {
        ...
        e = e.center;
        var h = this.a, l = h.ia(), m = l.f, n = l.Xa(f), p = n.xc(g, this.I), q = n.Qa(p), r = Math.round(g / q) || 1,
            u = a.extent;
        void 0 !== b.extent && (u = pb(u, b.extent));
        if (kb(u)) return !1;
        var x = tc(n, u, p), B = wc(n, p, x), A = l.Sc(c), y = {};
        y[p] = {};
        ...
        if (!(this.i && 16 < Date.now() - a.time && T || !fa && this.c && Wa(this.c, u) && this.wf == m && r == this.D && (T || q * c / A * r == this.i))) {
            if (T = this.context) ra = l.be(p, c, f), va = Math.round((x.da - x.ba + 1) * ra[0] / r), ra = Math.round((x.ga - x.ea + 1) * ra[1] / r), fa = T.canvas,
    ...
    Hi.prototype.Sf = function (a, b, c, d, e, f, g, h, l) {
        if (c = a.Y(this.a)) {
            var m = w(this), n = l ? Li(a, m, b.time) : 1;
    ...
    function Pi(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u) {
        ...
        0 !== p && (f = c + f, g = d + g, cf(x, f, g, 1, 1, p, -f, -g), b.setTransform.apply(b, x));
        x = b.globalAlpha;
    ...
    function Ri(a, b, c, d, e, f, g) {
        var h = a.coordinates.length, l = a.Wf();
        g && (c += e);
        g = [b[c], b[c + 1]];
        var m = [NaN, NaN], n = !0, p;
        for (p = c + e; p < d; p += e) {
    ...
    k.Eh = function (a, b, c) {
        ...
        } else "Polygon" == d || "MultiLineString" == d ? (h = [], d = "Polygon" == d ? a.Ub() : a.ca(), Si(this, d, 0, a.lb(), e, h), this.a.push([4, f, h, a, c, xf])) : "LineString" == d || "MultiPoint" == d ? (d = a.ca(), e = Ri(this, d, 0, d.length, e, !1, !1), this.a.push([4, f, e, a, c, wf])) : "Point" == d && (d = a.ca(), this.coordinates.push(d[0],
    ...
    function Vi(a, b, c, d, e, f, g, h) {
        if (a.B && ma(c, a.U)) var l = a.B; else a.B || (a.B = []), l = Re(a.coordinates, 0, a.coordinates.length, 2, c, a.B), Ye(a.U, c);
        c = !wb(e);
                ...
                if (u || md <= Ec) {
                    a:{
                        ...
                        for (var Cg = u[U], Dg = u[U + 1], pk = 0, ti = Math.sqrt(Math.pow(Cg - Je, 2) + Math.pow(Dg - Nf, 2)), ui = 0; ui < kf; ++ui) {
                            Ec = sh ? kf - ui - 1 : ui;
                            for (var Go = Cb(Ca[Ec]), lf = nc + Go / 2; U < Xb - 2 && pk + ti < lf;) Je = Cg, Nf = Dg, U += 2, Cg = u[U], Dg = u[U + 1], pk +=
                    ...
                    U = r.length;
                    if (T) for (Xb = p[p.length - 1].height, Ca = 0, Cb = p.length; Ca < Cb; ++Ca) nc = T[Ca % U], xd = p[Ca], r = xd.width / 2, u = q * xd.height + (.5 - q) * (xd.height - Xb) - A, Pi(a, b, nc[0], nc[1], xd, r, u, xd.height, 1, 0, 0, nc[2], y, !1, xd.width)
                }
                ++m;
                break;
            case 7:
    ...
    Xi.prototype.Wb = function (a) {
        var b = a.Oc(), c = a.kc(), d = a.Cg(1), e = a.Y(1), f = a.Vc();
        this.f = b[0];
        this.i = b[1];
        this.I = d;
        this.N = e;
    ...
    function $i(a) {
        ...
        b.Rd == c && b.Ld == d && ma(b.Md, e) && b.Nd == f && b.Od == g && b.Pd == h && b.Qd == l || (void 0 != b.td && b.td != a.coordinates.length && (a.a.push([12]), b.td = a.coordinates.length), b.td = 0, a.a.push([11, c, h * a.pixelRatio, d, g, l, Qi(a, e), f * a.pixelRatio], [1]), b.Rd = c, b.Ld = d, b.Md = e, b.Nd = f, b.Od = g, b.Pd = h, b.Qd = l)
    }

    k.qc = function (a, b) {
        var c = this.f, d = c.lineWidth;
        void 0 !== c.strokeStyle && void 0 !== d && ($i(this), Ti(this, b), this.b.push([11, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset], [1]), c = a.ca(), Zi(this, c, 0, c.length, a.pa()), this.b.push([12]), Ui(this, b))
    };
    k.rc = function (a, b) {
        var c = this.f, d = c.lineWidth;
        if (void 0 !== c.strokeStyle && void 0 !== d) {
            ...
            var e = 0, f;
            var g = 0;
            for (f = c.length; g < f; ++g) e = Zi(this, d, e, c[g], a);
            this.b.push([12]);
            Ui(this, b)
        }
    };
    ...
    k.tc = function (a, b) {
        ...
        if (void 0 !== c.fillStyle || void 0 !== d) {
            ...
            var e = 0, f;
            var g = 0;
            for (f = c.length; g < f; ++g) e = bj(this, d, e, c[g], a);
            Ui(this, b)
        }
    };
    k.cf = function () {
    ...
    k.forEach = function (a, b) {
        for (var c = this.a; c;) a.call(b, c.Hc, c.fc, this), c = c.fb
    };
    k.get = function (a) {
        a = this.b[a];
        wa(!!a, 15);
        if (a === this.f) return a.Hc;
        a === this.a ? (this.a = this.a.fb, this.a.Ob = null) : (a.fb.Ob = a.Ob, a.Ob.fb = a.fb);
        a.fb = null;
        a.Ob = this.f;
        this.f = this.f.fb = a;
        return a.Hc
    ...
    k.remove = function (a) {
        ...
        wa(!!b, 15);
        if (b === this.f) {
            if (this.f = b.Ob) this.f.fb = null
        } else if (b === this.a) {
            if (this.a = b.fb) this.a.Ob = null
        } else b.fb.Ob = b.Ob, b.Ob.fb = b.fb;
        delete this.b[a];
        --this.c;
        return b.Hc
    };
    ...
    function hj(a, b, c, d, e) {
        ...
        for (this.C = this.O = this.D = ""; gj(ij);) ij.pop()
    }

    v(hj, Oi);
    var ij = new fj, jj = function () {
        var a;
        return function (b) {
    ...
    hj.prototype.Sb = function (a, b) {
        var c = this.i, d = this.f, e = this.g;
        if ("" !== this.qa && e && (c || d)) {
            ...
            if ("line" === this.g.placement) {
                ...
                for (g = l.length; m < g; ++m) {
                    ...
                    la = this.qa;
                    fa = this.qa.length;
                    if (x) for (r = 0; r < fa; ++r) ca.push(mj(this, la.charAt(r), !1, x));
                    if (u) for (r = 0; r < fa; ++r) ca.push(mj(this,
                        la.charAt(r), u, !1));
                ...
                this.a.push([6, e, c, l, (a - this.o) * d, (m - this.l) *
                d, l.height, 1, 0, 0, this.v, this.s, 1, !0, l.width]);
    ...
    function mj(a, b, c, d) {
        ...
        if (!ij.b.hasOwnProperty(e)) {
            var g = a.f, h = a.i, l = a.g, m = a.j * a.pixelRatio, n = ej[l.textAlign || "center"];
            a = d && g.lineWidth ? g.lineWidth : 0;
            var p = [], q = lj(l.font, b, p), r = jj(l.font);
            q = dg(Math.ceil((q + a) * m), Math.ceil((r * f + a) * m));
            var u = q.canvas;
            ij.set(e, u);
            q.scale(m, m);
            q.font = l.font;
            d && (q.strokeStyle = g.strokeStyle, q.lineWidth = a * (ld ? m : 1), q.lineCap = g.lineCap, q.lineJoin = g.lineJoin, q.miterLimit = g.miterLimit, qd && (q.setLineDash(g.lineDash),
            ...
            g = .5 - n;
            h = n * u.width / m + g * a;
            if (d) for (d = 0; d < f; ++d) q.strokeText(b[d], h + g * p[d], .5 * a + d * r);
            if (c) for (d = 0; d < f; ++d) q.fillText(b[d], h + g * p[d], .5 * a + d * r)
        }
        return ij.get(e)
    }
    ...
    function qj(a) {
        if (void 0 !== oj[a]) return oj[a];
        for (var b = 2 * a + 1, c = Array(b), d = 0; d < b; d++) c[d] = Array(b);
        b = a;
        for (var e = d = 0; b >= d;) pj(c, a + b, a + d), pj(c, a + d, a + b), pj(c, a - d, a + b), pj(c, a - b, a + d), pj(c, a - b, a - d), pj(c, a - d, a - b), pj(c, a + d, a - b), pj(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e - b) + 1 && (--b, e += 1 - 2 * b);
        return oj[a] = c
    }
    ...
    nj.prototype.Fa = function (a, b, c, d, e, f) {
        d = Math.round(d);
        var g = 2 * d + 1, h = cf(this.j, d + .5, d + .5, 1 / b, -1 / b, -c, -a[0], -a[1]), l = this.g;
        ...
        return sj(this, l, h, c, e, function (a) {
            for (var b = l.getImageData(0, 0, g, g).data, c = 0; c < g; c++) for (var d = 0; d < g; d++) if (n[c][d] && 0 < b[4 * (d * g + c) + 3]) {
                if (a = f(a)) return a;
                l.clearRect(0, 0, g, g);
                return
            }
    ...
    nj.prototype.b = function (a, b) {
        ...
        c = a[b];
        void 0 === c && (c = new uj[b](this.s, this.f, this.v, this.o, this.l), a[b] = c);
        return c
    };
    ...
    function sj(a, b, c, d, e, f, g) {
        ...
        for (l = h.length; n < l; ++n) {
            ...
            for (m = dj.length - 1; 0 <= m; --m) {
                var q = p[dj[m]];
                if (void 0 !== q && (q = Vi(q, b, c, d, e, q.b, f, g))) return q
            }
        }
    }

    var uj = {Circle: aj, Default: Oi, Image: Xi, LineString: Yi, Polygon: aj, Text: hj};
    ...
    function xj(a, b, c, d, e, f) {
        ...
        if (h = c.Y()) {
            var l = h.gf();
            2 == l || 3 == l ? h.Qj(e, f) : (0 == l && h.load(), h.di(e, f), g = !0)
        }
        if (e = (0, c.Za)(b)) if (d = e.Zd(d), c.Je()) yj(a, d, c, b); else (0, zj[d.S()])(a, d, c, b);
        return g
    }
    ...
    function yj(a, b, c, d) {
        if ("GeometryCollection" == b.S()) {
            b = b.pd();
            for (var e = 0, f = b.length; e < f; ++e) yj(a, b[e], c, d)
    ...
    var zj = {
        Point: function (a, b, c, d) {
            ...
            if (e = c.Ia()) a = a.b(c.za(), "Text"), a.ib(e), a.Sb(b, d)
            ...
            var e;
            var f = 0;
            for (e = b.length; f < e; ++f) (0, zj[b[f].S()])(a, b[f], c, d)
    ...
    Aj.prototype.v = function (a, b, c) {
        var d = a.extent, e = a.pixelRatio, f = b.Ue ? a.skippedFeatureUids : {}, g = a.viewState, h = g.projection,
            l = g.rotation, m = h.G(), n = this.a.ia(), p = ri(this, a, 0);
        ...
        if (r && !r.c()) {
            ...
            if (n.C && h.f && !Wa(m, d)) {
                h = d[0];
                n = lb(m);
                for (var ca = 0; h < m[0];) --ca, p = n * ca, p = ri(this, a, p), r.Ka(A, p, l, f), h += n;
                ca = 0;
                for (h = d[2]; h > m[2];) ++ca, p = n * ca, p = ri(this, a, p), r.Ka(A, p, l, f), h -= n;
                p = ri(this, a, 0)
            }
            Mh(A, l, N / 2, e / 2);
            A != c && (B && qi(this, "render", A, a, p), x ? (d = c.globalAlpha, c.globalAlpha = b.opacity, c.drawImage(A.canvas, -q, -u), c.globalAlpha = d) : c.drawImage(A.canvas, -q, -u), A.translate(-q, -u));
            x ||
            (A.globalAlpha = y)
        }
        g && c.restore();
    ...
    Aj.prototype.Ad = function (a) {
        ...
        li(a, c);
        var d = a.viewHints[0], e = a.viewHints[1], f = b.U, g = b.ta;
        ...
        f = Ra(f, n * l);
        n = h.projection.G();
        c.C && h.projection.f && !Wa(n, a.extent) && (a = Math.max(lb(f) / 2, lb(n)), f[0] = n[0] - a, f[2] = n[2] + a);
        ...
        a = function (a) {
            ...
            if (d) {
                if (d) {
                    c = !1;
                    if (Array.isArray(d)) for (var e = 0, f = d.length; e < f; ++e) c = xj(p, a, d[e], wj(l, m), this.C, this) || c; else c = xj(p, a, d, wj(l, m), this.C, this) || c;
                    a = c
                } else a = !1;
                this.c = this.c || a
            }
    ...
    var Dj = {image: ["Polygon", "Circle", "LineString", "Image", "Text"], hybrid: ["Polygon", "LineString"]},
        Ej = {image: ["Default"], hybrid: ["Image", "Text", "Default"], vector: dj};
    k = Cj.prototype;
    k.Ad = function (a, b) {
        var c = this.a, d = c.f;
        this.fa != d && (this.g.length = 0, c = c.v, this.context || "vector" == c || (this.context = dg()), this.context && "vector" == c && (this.context = null));
        this.fa = d;
        return Hi.prototype.Ad.apply(this, arguments)
    };
    k.Sf = function (a, b, c, d, e, f, g, h, l) {
        var m = a, n = this.a, p = b.pixelRatio, q = b.viewState.projection, r = n.f, u = n.get(Bj) || null,
            x = Fj(m, n);
        if (x.Ee || x.wf != r || x.bh != u) {
            var B = n.ia(), A = B.tileGrid, y = B.Xa(q), N = y.Qa(m.wa[0]);
            y = y.Ja(m.O);
            for (var ca = 0, la = m.a.length; ca < la; ++ca) {
                var fa = m.c[m.a[ca]];
                if (3 != fa.getState()) {
                    var va = A.Ja(fa.wa), ra = pb(y, va), T = fa.s, U = !1;
                    hc(q, T) || (U = !0, fa.ug(q));
                    x.Ee = !1;
                    ra = new nj(0, ra, N, p, B.v, n.g);
                    var Xb = wj(N, p), Ca = fa.a;
                    u && u !== x.bh && Ca.sort(u);
                    for (var Cb, nc = 0, xd = Ca.length; nc < xd; ++nc) {
                        Cb = Ca[nc];
                        U && ("tile-pixels" ==
                        T.a && (T.Kj(va), T.Pi(fa.G())), Cb.W().hb(T, q));
                        var Ec = void 0, md = Cb.bb();
                        ...
                        if (Ec) {
                            ...
                            if (Ec) {
                                var kf = !1;
                                if (Array.isArray(Ec)) for (var Je = 0, Nf = Ec.length; Je < Nf; ++Je) kf = xj(sh, Cb, Ec[Je], md, this.Si, this) || kf; else kf = xj(sh, Cb, Ec, md, this.Si, this) || kf;
                                Cb = kf
                            } else Cb = !1;
                            this.C = this.C || Cb;
                            x.Ee = x.Ee || Cb
        ...
        if (this.context) {
            ...
            q = Fj(m, n);
            r = n.f;
            if ((p = Dj[n.v]) && q.dh !== r) for (q.dh = r, B = m.O, N =
                B[0], q = x.pixelRatio, y = n.ia(), A = y.Xa(x.viewState.projection), r = A.Qa(N), u = m.getContext(n), x = y.be(N, q, x.viewState.projection), u.canvas.width = x[0], u.canvas.height = x[1], x = A.Ja(B), B = 0, A = m.a.length; B < A; ++B) N = m.c[m.a[B]], 3 != N.getState() && (y = q / r, ca = Ve(this.U), af(ca, y, -y), bf(ca, -x[0], -x[3]), Gj(N, n, m.wa.toString()).Ka(u, ca, 0, {}, p, !0));
    ...
    k.pf = function (a, b, c) {
        var d = this.a, e = d.ia(), f = d.v, g = Ej[f], h = b.pixelRatio, l = b.viewState.rotation, m = b.size,
        ...
        for (var p = [], q = [], r = m.length - 1; 0 <= r; --r) {
            var u = m[r];
            if (5 != u.getState()) for (var x = u.wa, B = e.Ja(x)[0] - e.Ja(u.O)[0], A = 0, y = u.a.length; A < y; ++A) {
                var N = u.c[u.a[A]];
                if (3 != N.getState()) {
    ...
    Hj.prototype.D = function (a) {
        a.preventDefault();
        Jj() && (a = this.a) && (Ij() ? document.exitFullscreen ? document.exitFullscreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen() : (a = this.j ? "string" === typeof this.j ? document.getElementById(this.j) : this.j : a.wc(), this.C ? a.mozRequestFullScreenWithKeys ? a.mozRequestFullScreenWithKeys() : a.webkitRequestFullscreen ? a.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT) :
            Kj(a) : Kj(a)))
    };
    Hj.prototype.s = function () {
        var a = this.element.firstElementChild, b = this.a;
        Ij() ? (a.className = this.c + "-true", eg(this.o, this.l)) : (a.className = this.c + "-false", eg(this.l, this.o));
        b && b.Gc()
    };
    ...
    function Mj(a) {
        ...
        qg.call(this, {element: b, render: a.render ? a.render : Nj, target: a.target});
    ...
    k.setMap = function (a) {
        qg.prototype.setMap.call(this, a);
        a && (a = a.a, this.v.push(z(a, "mousemove", this.Tl, this), z(a, "mouseout", this.Ul, this)))
    };
    k.yj = function (a) {
        this.set(Qj, a)
    };
    ...
    function Pj(a, b) {
        ...
        if (b && a.c) {
            ...
            if (b = a.a.Na(b)) a.j(b, b), c = (c = a.Nh()) ? c(b) : b.toString()
        }
        a.o && c == a.o || (a.element.innerHTML = c, a.o = c)
    }

    var Oj = "projection", Qj = "coordinateFormat";
    ...
    k.Rl = function () {
        this.i && (fg(this.c), Hc(this.i), this.i = null);
        var a = this.We();
        a && (this.i = z(a, "postrender", this.render, this), Xj(this), a = this.v ? a.v : a.s, this.o ? a.insertBefore(this.c, a.childNodes[0] || null) : a.appendChild(this.c))
    };
    k.render = function () {
        Xj(this)
    };
    ...
    k.Xl = function () {
        ...
        if (this.get(Vj) && this.autoPan) {
            var a = this.We();
            if (a && a.wc()) {
                var b = Yj(a.wc(), a.zb()), c = this.Vd(), d = c.offsetWidth, e = getComputedStyle(c);
    ...
    function Xj(a) {
        ...
        if (b && b.c && c) {
            ...
            var g = e[0];
            e = e[1];
            if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Te && (a.a.Te = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.xf != g && (a.a.xf = b.right = g); else {
            ...
            if ("bottom-left" == f || "bottom-center" == f || "bottom-right" ==
                f) "" !== a.a.Ef && (a.a.Ef = b.top = ""), c = Math.round(d[1] - c[1] - e) + "px", a.a.Ce != c && (a.a.Ce = b.bottom = c); else {
    ...
    var Sj = "element", Tj = "map", Uj = "offset", Vj = "position", Wj = "positioning";
    ...
    function ak(a) {
        ...
        function c(a) {
            a = h.Wd({clientX: a.clientX - n.offsetWidth / 2, clientY: a.clientY + n.offsetHeight / 2});
            m.Xe(a)
        }
        ...
        this.o = new Rj({position: [0, 0], positioning: "bottom-left", element: e});
        this.c.Be(this.o);
        e = document.createElement("div");
        e.className = d + " ol-unselectable ol-control" + (this.j && this.l ? " ol-collapsed" : "") + (this.l ? "" : " ol-uncollapsible");
        e.appendChild(this.D);
        e.appendChild(f);
        qg.call(this, {element: e, render: a.render ? a.render : bk, target: a.target});
        var l = this, m = this.o, n = this.o.Vd();
    ...
    k.setMap = function (a) {
        var b = this.a;
        a !== b && (b && ((b = b.$()) && Nc(b, Yc("rotation"), this.Re, this), this.c.vd(null)), qg.prototype.setMap.call(this, a), a && (this.c.vd(this.D), this.v.push(z(a, "propertychange", this.Sl, this)), 0 === this.c.Ye().gc() && this.c.zf(a.dc()), a = a.$())) && (z(a, Yc("rotation"), this.Re, this), Wf(a) && (this.c.Gc(), ck(this)))
    };
    k.Sl = function (a) {
        "view" === a.key && ((a = a.oldValue) && Nc(a, Yc("rotation"), this.Re, this), a = this.a.$(), z(a, Yc("rotation"), this.Re, this))
    };
    k.Re = function () {
        this.c.$().de(this.a.$().Pa())
    };
    ...
    function bk() {
        ...
        if (a.c && b.c) {
            ...
            f = d[0];
            d = d[1];
            b < .1 * f || e < .1 * d || b > .75 * f || e > .75 * d ? ck(this) : Wa(c, a) || (a = this.c, c = this.a.$(), a.$().rb(c.xa()))
        }
        dk(this)
    }
    ...
    function ek(a) {
        ...
        a.j = !a.j;
        var b = a.c;
        a.j || b.c || (b.Gc(), ck(a), Mc(b, "postrender", function () {
            dk(this)
        }, a))
    }
    ...
    k.nn = function (a) {
        this.l !== a && (this.l = a, this.element.classList.toggle("ol-uncollapsible"), !a && this.j && ek(this))
    };
    k.mn = function (a) {
    ...
    function fk(a) {
        ...
        this.B = void 0;
        this.C = "";
        qg.call(this, {element: this.c, render: a.render ? a.render : gk, target: a.target});
    ...
    function kk(a) {
        ...
        z(this.l, "pointerup", this.Fl,
            this);
        z(d, "click", this.Dl, this);
        z(c, "click", Sc);
        qg.call(this, {element: d, render: a.render ? a.render : mk})
    }
    ...
    function mk(a) {
        if (a.frameState) {
            if (!this.ta) {
                ...
                this.I = [b, e];
                c > d ? (this.j = 1, this.C = c - b) : (this.j = lk, this.o = d - e);
                this.ta = !0
            }
            a = a.frameState.viewState.resolution;
            a !== this.c && (this.c = a, nk(this, a))
        }
    }
    ...
    k.Dl = function (a) {
        ...
        b.animate({resolution: b.constrainResolution(a), duration: this.U, easing: Me})
    };
    k.Gl = function (a) {
        this.s || a.b.target !== this.element.firstElementChild || (Xf(this.a.$(), 1, 1), this.D = a.clientX, this.B = a.clientY, this.s = !0)
    };
    k.El = function (a) {
        if (this.s) {
    ...
    k.Fl = function () {
        if (this.s) {
            var a = this.a.$();
            Xf(a, 1, -1);
            a.animate({resolution: a.constrainResolution(this.c), duration: this.U, easing: Me});
            this.s = !1;
    ...
    k.Gm = function () {
        if (sd) {
            var a = this.ii();
            a && !this.a ? this.a = z(window, "deviceorientation", this.jp, this) : a || null === this.a || (Hc(this.a), this.a = null)
        }
    };
    k.qg = function (a) {
        this.set(tk, a)
    };
    var uk = "alpha", wk = "beta", xk = "gamma", vk = "heading", tk = "tracking";
    ...
    function Ak(a, b) {
        ...
        var m = 2 * (a.b + h) + 1;
        c = {strokeStyle: l, Oj: h, size: m, lineCap: c, lineDash: f, lineDashOffset: g, lineJoin: d, miterLimit: e};
        if (void 0 === b) {
            var n = dg(m, m);
            a.s = n.canvas;
            b = m = a.s.width;
            a.Gh(c, n, 0, 0);
            a.Wa ? a.C = a.s : (n = dg(c.size, c.size), a.C = n.canvas, a.Fh(c, n, 0, 0))
        } else m =
            ...
            f = "-", a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.f == a.c[4] && a.j == a.c[5] && a.l == a.c[6] || (a.c = ["r" + e + f + (void 0 !== a.b ? a.b.toString() : "-") + (void 0 !== a.f ? a.f.toString() : "-") + (void 0 !== a.j ? a.j.toString() : "-") + (void 0 !== a.l ? a.l.toString() : "-"), e, f, a.b, a.f, a.j, a.l]), n = b.add(a.c[0], m, m, a.Gh.bind(a, c), n), a.s = n.image, a.ra = [n.offsetX, n.offsetY], b = n.image.width, a.C = d ? n.hm : a.s;
        a.D = [m / 2, m / 2];
        a.sa = [m, m];
        a.B = [b, b]
    }
    ...
    k.Gh = function (a, b, c, d) {
        ...
        this.Wa && (c = this.Wa.b, null === c && (c = Jh), b.fillStyle = Th(c), b.fill());
        this.Ta && (b.strokeStyle = a.strokeStyle, b.lineWidth = a.Oj, a.lineDash && (b.setLineDash(a.lineDash),
    ...
    k.Fh = function (a, b, c, d) {
        ...
        b.fillStyle = Jh;
        b.fill();
        this.Ta && (b.strokeStyle = a.strokeStyle, b.lineWidth = a.Oj, a.lineDash && (b.setLineDash(a.lineDash), b.lineDashOffset = a.lineDashOffset),
            b.stroke());
        b.closePath()
    };
    ...
    Ck.prototype.clone = function () {
        var a = this.b;
        return new Ck({color: a && a.slice ? a.slice() : a || void 0})
    };
    ...
    function Gk(a) {
        if ("function" !== typeof a) {
            if (Array.isArray(a)) var b = a; else wa(a instanceof Ek, 41), b = [a];
            a = function () {
                return b
            }
        }
    ...
    function Ik() {
        if (!Hk) {
            var a = new Ck({color: "rgba(255,255,255,0.4)"}), b = new Dk({color: "#3399CC", width: 1.25});
            Hk = [new Ek({image: new Bk({fill: a, stroke: b, radius: 5}), fill: a, stroke: b})]
        }
        return Hk
    }
    ...
    function Jk() {
        ...
        a.Polygon = [new Ek({fill: new Ck({color: [255, 255, 255, .5]})})];
        a.MultiPolygon = a.Polygon;
        a.LineString = [new Ek({stroke: new Dk({color: b, width: 5})}), new Ek({stroke: new Dk({color: c, width: 3})})];
        a.MultiLineString = a.LineString;
        a.Circle = a.Polygon.concat(a.LineString);
        a.Point = [new Ek({
            image: new Bk({radius: 6, fill: new Ck({color: c}), stroke: new Dk({color: b, width: 1.5})}),
            zIndex: Infinity
        })];
    ...
    function Lk(a) {
        ...
        if ("function" === typeof a) 2 == a.length ? b = function (b) {
            ...
            if (Array.isArray(a)) var c = a; else wa(a instanceof Ek, 41), c = [a];
            b = function () {
                return c
            }
        }
        ...
        return function (e, f, g) {
            ...
            h.onload = function () {
                if (!h.status || 200 <= h.status && 300 > h.status) {
                    var a = b.S();
                    if ("json" == a || "text" == a) var e = h.responseText; else "xml" == a ? (e = h.responseXML) || (e = Sk(h.responseText)) : "arraybuffer" == a && (e = h.response);
                    e ? c.call(this, b.Ma(e, {featureProjection: g}), b.pb(e), b.dg()) : d.call(this)
                } else d.call(this)
            }.bind(this);
            h.onerror = function () {
                d.call(this)
    ...
    function nl(a, b, c, d, e, f) {
        var g = 0;
        if (f) return ml(a, g, b[b.length - 1], c, d, e);
        ...
        for (f = b.length; e < f; ++e) {
            var h = b[e];
            if (g != h) {
                if (d < a[g + c - 1]) break; else if (d <= a[h - 1]) return ml(a, g, h, c, d, !1);
                g = h
            }
        }
        return null
    ...
    k.Mb = function (a, b, c, d) {
        if (d < Ta(this.G(), a, b)) return d;
        this.s != this.f && (this.C = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0)), this.s = this.f);
    ...
    function bi(a) {
        a.j != a.f && (a.c = a.Mh(.5, a.c), a.j = a.f);
        return a.c
    }
    ...
    k.na = function (a, b) {
        a ? (jf(this, b, a, 1), this.A || (this.A = []), this.A.length = uf(this.A, 0, a, this.a), this.u()) : this.aa("XY", null)
    };
    k.aa = function (a, b) {
        hf(this, a, b);
        this.u()
    ...
    k.Mb = function (a, b, c, d) {
        if (d < Ta(this.G(), a, b)) return d;
        this.j != this.f && (this.s = Math.sqrt(qf(this.A, 0, this.c, this.a, 0)), this.j = this.f);
    ...
    function di(a) {
        if (a.I != a.f) {
            ...
            a:{
                ...
                var d;
                var e = 0;
                for (d = c.length; e < d; ++e) if (!Lf(b, c[e], a.a, void 0)) {
                    c = !1;
                    break a
                }
                c = !0
            }
            c ? a.j = b : (a.j = b.slice(), a.j.length = Of(a.j, a.c, a.a));
            a.I = a.f
        }
        return a.j
    }
    ...
    k.na = function (a, b) {
        if (a) {
            ...
            var f = 0, g;
            var h = 0;
            for (g = a.length; h < g; ++h) e = vf(b, e, a[h], c, d[f]), d[f++] = e, e = e[e.length - 1];
            d.length = f;
    ...
    function tl(a, b) {
        ...
        if ("number" === typeof a.x && "number" === typeof a.y) var c = "Point"; else if (a.points) c = "MultiPoint"; else if (a.paths) c = 1 === a.paths.length ? "LineString" : "MultiLineString"; else if (a.rings) {
            var d = a.rings, e = ul(a), f = [], g = [];
            c = [];
            var h;
            var l = 0;
            for (h = d.length; l < h; ++l) f.length = 0, uf(f, 0, d[l], e.length), Kf(f, 0, f.length, e.length) ? g.push([d[l]]) : c.push(d[l]);
            for (; c.length;) {
                d = c.shift();
                e = !1;
                for (l = g.length - 1; 0 <= l; l--) if (Wa((new Bf(g[l][0])).G(), (new Bf(d)).G())) {
                    g[l].push(d);
                    e = !0;
                    break
                }
    ...
    k = sl.prototype;
    k.Xc = function (a, b) {
        var c = tl(a.geometry, b), d = new Kk;
        this.b && d.Zc(this.b);
        d.Sa(c);
    ...
    k.Kg = function (a, b) {
        ...
        if (a.features) {
            ...
            a = 0;
            for (e = d.length; a < e; ++a) c.push(this.Xc(d[a], b));
            return c
        }
        return [this.Xc(a, b)]
    };
    ...
    k.ed = function (a, b) {
        b = hl(this, b);
        var c = {}, d = a.W();
        d && (c.geometry = yl(d, b), b && b.featureProjection && (c.geometry.spatialReference = {wkid: Zb(b.featureProjection).sb.split(":").pop()}));
        b = a.M();
        delete b[a.a];
        c.attributes = wb(b) ? {} : b;
        return c
    ...
    k.Mb = function (a, b, c, d) {
        ...
        var e = this.a, f;
        var g = 0;
        for (f = e.length; g < f; ++g) d = e[g].Mb(a, b, c, d);
        return d
    };
    k.Tc = function (a, b) {
        var c = this.a, d;
        var e = 0;
        for (d = c.length; e < d; ++e) if (c[e].Tc(a, b)) return !0;
        return !1
    };
    k.De = function (a) {
        Za(a);
    ...
    k.Zd = function (a) {
        ...
        if (e) return a = new Wl(null), Zl(a), a.a = c, Xl(a), a.u(), this.i[b] = a;
        this.g = a;
        return this
    };
    k.S = function () {
    ...
    function am(a, b) {
        return a ? il((0, bm[a.type])(a), !1, b) : null
    }

    function cm(a, b) {
        return (0, dm[a.S()])(il(a, !0, b), b)
    }
    ...
    k.Kg = function (a, b) {
        if ("FeatureCollection" === a.type) {
            ...
            var d;
            var e = 0;
            for (d = a.length; e < d; ++e) c.push(this.Xc(a[e], b))
        } else c = [this.Xc(a, b)];
        return c
    };
    k.Og = function (a, b) {
    ...
    k.Vb = function (a, b) {
        return Qk(a) ? fm(this, a, b) : Rk(a) ? this.Jg(a, b) : "string" === typeof a ? (a = Sk(a), fm(this, a, b)) : null
    };
    ...
    k.Ma = function (a, b) {
        return Qk(a) ? gm(this, a, b) : Rk(a) ? this.Dc(a, b) : "string" === typeof a ? (a = Sk(a), gm(this, a, b)) : []
    };
    ...
    k.pb = function (a) {
        return Qk(a) ? this.Qg(a) : Rk(a) ? this.uf(a) : "string" === typeof a ? (a = Sk(a), this.Qg(a)) : null
    };
    k.Qg = function () {
    ...
    k.ie = function (a, b) {
        ...
        if ("FeatureCollection" == c) "http://www.opengis.net/wfs" === a.namespaceURI ? d = L([], this.b, a, b, this) : d = L(null, this.b, a, b, this); else if ("featureMembers" == c || "featureMember" == c) {
            ...
            for (var u in g) {
                n = {};
                l = 0;
                for (h = f.length; l < h; ++l) (-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u && (n[f[l].split(":").pop()] = "featureMembers" == c ? Uk(this.Ig, this) : Vk(this.Ig, this));
                e[g[u]] = n
            }
    ...
    k.rf = function (a, b) {
        ...
        if (a = L(null, this.oh, a, b, this)) return il(a, !1, c)
    };
    k.Ig = function (a, b) {
        var c;
        ...
        for (a = a.firstElementChild; a; a = a.nextElementSibling) {
            ...
            if (0 === a.childNodes.length || 1 === a.childNodes.length && (3 === a.firstChild.nodeType || 4 === a.firstChild.nodeType)) {
                ...
                im.test(g) && (g = void 0);
                d[f] = g
            } else "boundedBy" !== f && (e = f), d[f] = this.rf(a, b)
        }
        b = new Kk(d);
        e && b.Zc(e);
        c && b.mc(c);
    ...
    k.tj = function (a, b) {
        if (a = this.qf(a, b)) return b = new D(null), b.aa("XYZ", a), b
    };
    k.rj = function (a, b) {
        if (a = L([], this.ck, a, b, this)) return new ql(a)
    };
    k.qj = function (a, b) {
        if (a = L([], this.bk, a, b, this)) return b = new O(null), pl(b, a), b
    };
    k.sj = function (a, b) {
        if (a = L([], this.dk, a, b, this)) return b = new P(null), rl(b, a), b
    };
    k.kj = function (a, b) {
        bl(this.gk, a, b, this)
    };
    ...
    k.sf = function (a, b) {
        if (a = this.qf(a, b)) return b = new M(null), b.aa("XYZ", a), b
    };
    k.Ep = function (a, b) {
        if (a = L(null, this.we, a, b, this)) return a
    };
    k.pj = function (a, b) {
        if (a = this.qf(a, b)) return b = new Bf(null), Cf(b, "XYZ", a), b
    };
    k.tf = function (a, b) {
    ...
    k.dk = {"http://www.opengis.net/gml": {polygonMember: Uk(hm.prototype.lj), polygonMembers: Uk(hm.prototype.lj)}};
    k.gk = {"http://www.opengis.net/gml": {Point: Uk(hm.prototype.qf)}};
    k.$j = {"http://www.opengis.net/gml": {LineString: Uk(hm.prototype.sf)}};
    k.hk = {"http://www.opengis.net/gml": {Polygon: Uk(hm.prototype.tf)}};
    k.xe = {"http://www.opengis.net/gml": {LinearRing: Vk(hm.prototype.Ep)}};
    k.oj = function (a, b) {
    ...
    k = um.prototype;
    k.Ip = function (a, b) {
        if (a = L([], this.ak, a, b, this)) return b = new O(null), pl(b, a), b
    };
    k.Jp = function (a, b) {
        if (a = L([], this.ek, a, b, this)) return b = new P(null), rl(b, a), b
    };
    k.Dh = function (a, b) {
        bl(this.Xj, a, b, this)
    };
    ...
    k.mj = function (a, b) {
        if (a = L([null], this.Yj, a, b, this)) return b = new M(null), b.aa("XYZ", a), b
    };
    k.Dp = function (a, b) {
    ...
    k.we = {"http://www.opengis.net/gml": {pos: Vk(um.prototype.Fp), posList: Vk(um.prototype.Ng)}};
    k.Gf = {"http://www.opengis.net/gml": {interior: um.prototype.lm, exterior: um.prototype.Jk}};
    k.oh = {
        "http://www.opengis.net/gml": {
    ...
    k.ak = {"http://www.opengis.net/gml": {curveMember: Uk(um.prototype.Dh), curveMembers: Uk(um.prototype.Dh)}};
    k.ek = {"http://www.opengis.net/gml": {surfaceMember: Uk(um.prototype.Pj), surfaceMembers: Uk(um.prototype.Pj)}};
    k.Xj = {"http://www.opengis.net/gml": {LineString: Uk(hm.prototype.sf), Curve: Uk(um.prototype.mj)}};
    k.jk = {"http://www.opengis.net/gml": {Polygon: Uk(hm.prototype.tf), Surface: Uk(um.prototype.uj)}};
    k.kk = {"http://www.opengis.net/gml": {patches: Vk(um.prototype.Mp)}};
    k.Yj = {"http://www.opengis.net/gml": {segments: Vk(um.prototype.Pp)}};
    k.Zj = {"http://www.opengis.net/gml": {lowerCorner: Uk(um.prototype.Ng), upperCorner: Uk(um.prototype.Ng)}};
    k.fk = {"http://www.opengis.net/gml": {PolygonPatch: Vk(um.prototype.Np)}};
    k.ik = {"http://www.opengis.net/gml": {LineStringSegment: Vk(um.prototype.Hp)}};
    ...
    var wm = {"http://www.opengis.net/gml": {lowerCorner: J(rm), upperCorner: J(rm)}};
    k = um.prototype;
    k.vn = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
        cl({node: a}, wm, $k, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
    };
    k.Bi = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
    ...
    k.bf = function (a, b, c) {
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Xd(), cl({
            node: a,
            hasZ: e,
            srsName: d
        }, xm, this.tn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = Nk(a.namespaceURI, "patches"), a.appendChild(e), a = Nk(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.bf(a, b, c))
    };
    k.af = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
        "LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = Nk(a.namespaceURI, "posList"), a.appendChild(d), vm(d, b, c)) : "Curve" === a.nodeName && (d = Nk(a.namespaceURI, "segments"), a.appendChild(d), a = Nk(d.namespaceURI, "LineStringSegment"), d.appendChild(a), this.af(a, b, c))
    };
    k.Di = function (a, b, c) {
        ...
        b = b.Yd();
        cl({node: a, hasZ: e, srsName: f, surface: d}, ym, this.l, b, c, void 0, this)
    };
    k.wn = function (a, b, c) {
        ...
        b = b.ee();
        cl({node: a, hasZ: d, srsName: e}, zm, Yk("pointMember"), b, c, void 0, this)
    };
    k.Ci = function (a, b, c) {
        var d = c[c.length - 1], e = d.hasZ, f = d.srsName;
        d = d.curve;
        f && a.setAttribute("srsName", f);
        b = b.qd();
        cl({node: a, hasZ: e, srsName: f, curve: d}, Am, this.l, b, c, void 0, this)
    };
    k.Fi = function (a, b, c) {
    ...
    k.zi = function (a, b, c) {
        ...
        for (m in g) {
            var l = g[m];
            null !== l && (b.push(m), h.push(l), m == f || l instanceof ef ? m in d.qb[e] || (d.qb[e][m] = J(this.wd, this)) : m in d.qb[e] || (d.qb[e][m] = J(rm)))
        }
        var m = tb({}, d);
        m.node = a;
        cl(m, d.qb, Yk(void 0, e), h, c, b)
    };
    var ym = {"http://www.opengis.net/gml": {surfaceMember: J(um.prototype.Gi), polygonMember: J(um.prototype.Gi)}},
        zm = {"http://www.opengis.net/gml": {pointMember: J(um.prototype.xn)}},
        Am = {"http://www.opengis.net/gml": {lineStringMember: J(um.prototype.Ai), curveMember: J(um.prototype.Ai)}},
        xm = {"http://www.opengis.net/gml": {exterior: J(um.prototype.Fi), interior: J(um.prototype.Fi)}}, Bm = {
            "http://www.opengis.net/gml": {
    ...
    um.prototype.ue = function (a, b) {
        b = hl(this, b);
        var c = Nk("http://www.opengis.net/gml", "geom"), d = {
            node: c,
            hasZ: this.hasZ,
    ...
    k.nj = function (a, b) {
        ...
        c && (c = Zb(c)) && (b = c.b);
        a = a.trim().split(/\s+/);
        for (var d, e, f = [], g = 0, h = a.length; g < h; g++) e = a[g].split(/,+/), c = parseFloat(e[0]), d = parseFloat(e[1]), e = 3 === e.length ? parseFloat(e[2]) : 0, "en" === b.substr(0, 2) ? f.push(c, d, e) : f.push(d, c, e);
        return f
    };
    k.Bp = function (a, b) {
    ...
    k.we = {"http://www.opengis.net/gml": {coordinates: Vk(Dm.prototype.nj)}};
    k.Gf = {"http://www.opengis.net/gml": {innerBoundaryIs: Dm.prototype.jm, outerBoundaryIs: Dm.prototype.kp}};
    k.Wj = {"http://www.opengis.net/gml": {coordinates: Uk(Dm.prototype.nj)}};
    k.oh = {
        "http://www.opengis.net/gml": {
            Point: Vk(hm.prototype.tj),
            MultiPoint: Vk(hm.prototype.rj),
    ...
    k.Ze = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
        "LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = Fm(a.namespaceURI), a.appendChild(d), Gm(d, b, c)) : "Curve" === a.nodeName && (d = Nk(a.namespaceURI, "segments"), a.appendChild(d), a = Nk(d.namespaceURI, "LineStringSegment"), d.appendChild(a), this.Ze(a, b, c))
    };
    ...
    function Gm(a, b, c) {
        ...
        d = d.srsName;
        b = b.V();
        for (var e = b.length, f = Array(e), g, h = 0; h < e; ++h) g = b[h], f[h] = Hm(g, d, c);
        rm(a, f.join(" "))
    }
    ...
    k.$e = function (a, b, c) {
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Xd(), cl({
            ...
            hasZ: e,
            srsName: d
        }, Im, this.pn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = Nk(a.namespaceURI, "patches"), a.appendChild(e), a = Nk(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.$e(a, b, c))
    };
    k.pn = function (a, b) {
        a = b[b.length - 1];
        b = a.node;
    ...
    k.ui = function (a, b, c) {
        ...
        f && a.setAttribute("srsName", f);
        b = b.qd();
        cl({node: a, hasZ: e, srsName: f, curve: d}, Jm, this.a, b, c, void 0, this)
    };
    k.wi = function (a, b, c) {
        var d = c[c.length - 1];
        c = d.hasZ;
    ...
    k.rn = function (a, b, c) {
        ...
        b = b.ee();
        cl({node: a, hasZ: e, srsName: d}, Km, Yk("pointMember"), b, c, void 0, this)
    };
    k.sn = function (a, b, c) {
        var d = Nk(a.namespaceURI, "Point");
        a.appendChild(d);
    ...
    k.vi = function (a, b, c) {
        ...
        f && a.setAttribute("srsName", f);
        b = b.Yd();
        cl({node: a, hasZ: e, srsName: f, surface: d}, Lm, this.a, b, c, void 0, this)
    };
    k.yi = function (a, b, c) {
        var d = this.vg(b, c);
    ...
    k.qn = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
        cl({node: a}, Mm, $k, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
    };
    var Em = {
            "http://www.opengis.net/gml": {
        ...
        }, Im = {"http://www.opengis.net/gml": {outerBoundaryIs: J(Dm.prototype.xi), innerBoundaryIs: J(Dm.prototype.xi)}},
        Km = {"http://www.opengis.net/gml": {pointMember: J(Dm.prototype.sn)}},
        Jm = {"http://www.opengis.net/gml": {lineStringMember: J(Dm.prototype.si), curveMember: J(Dm.prototype.si)}};
    ...
    var Nm = {
            ...
            MultiPolygon: "polygonMember",
            MultiSurface: "surfaceMember"
        }, Lm = {"http://www.opengis.net/gml": {surfaceMember: J(Dm.prototype.yi), polygonMember: J(Dm.prototype.yi)}},
        Mm = {"http://www.opengis.net/gml": {lowerCorner: J(rm), upperCorner: J(rm)}};
    ...
    function Vm(a, b) {
        var c = b[0];
        if (a = L({flatCoordinates: [], layoutOptions: {}}, Wm, a, b)) {
            b = a.flatCoordinates;
    ...
    function Xm(a, b) {
        var c = b[0];
        if (a = L({flatCoordinates: [], ends: [], layoutOptions: {}}, Ym, a, b)) {
            b = a.flatCoordinates;
            delete a.flatCoordinates;
            var d = a.ends;
            delete a.ends;
    ...
    var an = {rte: Vm, trk: Xm, wpt: Zm}, bn = K(Pm, {rte: Uk(Vm), trk: Uk(Xm), wpt: Uk(Zm)}),
        Tm = K(Pm, {text: I(Q, "linkText"), type: I(Q, "linkType")}), Wm = K(Pm, {
            name: I(Q),
            cmt: I(Q),
            desc: I(Q),
            src: I(Q),
            ...
            rtept: function (a, b) {
                var c = L({}, cn, a, b);
                c && (b = b[b.length - 1], Qm(b.flatCoordinates, b.layoutOptions, a, c))
            }
        }), cn = K(Pm, {ele: I(mm), time: I(lm)}), Ym = K(Pm, {
            name: I(Q),
            cmt: I(Q),
            desc: I(Q),
            src: I(Q),
        ...
        }), en = K(Pm, {ele: I(mm), time: I(lm)}), $m = K(Pm, {
            ele: I(mm),
            time: I(lm),
            magvar: I(mm),
            geoidheight: I(mm),
    ...
    Om.prototype.Jg = function (a, b) {
        if (!ha(Pm, a.namespaceURI)) return null;
    ...
    Om.prototype.Dc = function (a, b) {
        return ha(Pm, a.namespaceURI) ? "gpx" == a.localName && (a = L([], bn, a, [gl(this, a, b)])) ? (fn(this, a), a) : [] : []
    };

    function gn(a, b, c) {
        a.setAttribute("href", b);
        b = c[c.length - 1].properties;
        cl({node: a}, hn, $k, [b.linkText, b.linkType], c, jn)
    }
    ...
    function kn(a, b, c) {
        ...
        d = al(f, b);
        cl({node: a, properties: f}, nn, $k, d, c, b)
    }

    var jn = ["text", "type"], hn = K(Pm, {text: J(rm), type: J(rm)}),
        on = K(Pm, "name cmt desc src link number type rtept".split(" ")), pn = K(Pm, {
            name: J(rm),
            cmt: J(rm),
            desc: J(rm),
            src: J(rm),
            ...
            type: J(rm),
            rtept: Xk(J(kn))
        }), ln = K(Pm, ["ele", "time"]), qn = K(Pm, "name cmt desc src link number type trkseg".split(" ")), tn = K(Pm, {
            name: J(rm),
            cmt: J(rm),
            desc: J(rm),
            src: J(rm),
            ...
            trkseg: Xk(J(function (a, b, c) {
                cl({node: a, geometryLayout: b.ja, properties: {}}, rn, sn, b.V(), c)
            }))
        }), sn = Yk("trkpt"),
        rn = K(Pm, {trkpt: J(kn)}),
        ...
        nn = K(Pm, {
            ...
            ageofdgpsdata: J(sm),
            dgpsid: J(tm)
        }), un = {Point: "wpt", LineString: "rte", MultiLineString: "trk"};

    function vn(a, b) {
        if (a = a.W()) if (a = un[a.S()]) return Nk(b[b.length - 1].node.namespaceURI, a)
    }
    ...
    var wn = K(Pm, {
        rte: J(function (a, b, c) {
            ...
            if (b = b.W()) b = il(b, !0, d), a.geometryLayout = b.ja, e.rtept = b.V();
            ...
            var d = c[0], e = b.M();
            a = {node: a, properties: e};
            if (b = b.W()) b = il(b, !0, d), e.trkseg = b.qd();
            ...
            e.properties = b.M();
            if (b = b.W()) b = il(b, !0, d), e.geometryLayout = b.ja, kn(a, b.V(),
                c)
        })
    });
    ...
    var An = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/,
        Bn = /^H.([A-Z]{3}).*?:(.*)/, Cn = /^HFDTE(\d{2})(\d{2})(\d{2})/, Dn = /\r\n|\r|\n/;
    k = zn.prototype;
    k.he = function (a, b) {
        var c = this.b, d = a.split(Dn);
        a = {};
        ...
        for (m = d.length; n < m; ++n) {
            ...
            } else "H" == p.charAt(0) && ((q = Cn.exec(p)) ? (h = parseInt(q[1], 10), g = parseInt(q[2], 10) - 1, f = 2E3 + parseInt(q[3], 10)) : (q = Bn.exec(p)) && (a[q[1]] = q[2].trim()))
        }
    ...
    En.prototype.s = function () {
        ...
        if (!this.o && null !== this.g) {
            ...
            for (var b = a.getImageData(0, 0, this.N.width, this.N.height), c = b.data, d = this.g[0] / 255, e = this.g[1] / 255, f = this.g[2] / 255, g = 0, h = c.length; g < h; g += 4) c[g] *= d, c[g + 1] *= e, c[g + 2] *= f;
    ...
    function Gn(a) {
        ...
        var f = this.sa, g = this.j, h = zi.get(d, f, g);
        h || (h = new En(b, d, c, f, e, g), zi.set(d, f, g, h));
        this.b = h;
    ...
    function Hn(a) {
        ...
        this.Wa = void 0 !== a.fill ? a.fill : new Ck({color: "#333"});
    ...
    function In(a) {
        a = a ? a : {};
        em.call(this);
        Jn || (Kn = [255, 255, 255, 1], Ln = new Ck({color: Kn}), Mn = [20, 2], Nn = On = "pixels", Pn = [64, 64], Qn = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", Rn = .5, Sn = new Gn({
            anchor: Mn,
            ...
            size: Pn,
            src: Qn
        }), Tn = "NO_IMAGE", Un = new Dk({color: Kn, width: 1}), Vn = new Dk({
            color: [51, 51, 51, 1],
            width: 2
        }), Wn = new Hn({font: "bold 16px Helvetica", fill: Ln, stroke: Vn, scale: .8}), Xn = new Ek({
            fill: Ln,
            image: Sn, text: Wn, stroke: Un, zIndex: 0
        }), Jn = [Xn]);
        this.defaultDataProjection = Zb("EPSG:4326");
    ...
    var Yn = ["http://www.google.com/kml/ext/2.2"],
        ...
        $n = {fraction: "fraction", pixels: "pixels", insetPixels: "pixels"};
    ...
    function ao(a, b) {
        ...
        null !== a.Ia() ? (e = a.Ia(), a = e.clone(), a.Bj(e.a || Wn.a), a.fj(e.b || Wn.b), a.yf(e.Ca() || Wn.Ca()), a.Af(e.Da() || Vn)) : a = Wn.clone();
        a.Ed(b);
        a.Fj(c[0]);
        a.Gj(c[1]);
        a.Ij(d);
        return new Ek({text: a})
    }
    ...
    function bo(a, b, c, d, e) {
        return function () {
            ...
            if (a) return f ? (f = ao(a[0], g), a.concat(f)) : a;
            if (b) {
                var h = co(b, c, d);
                return f ? (f = ao(h[0], g), h.concat(f)) : h
            }
            return f ? (f = ao(c[0], g), c.concat(f)) : c
        }
    }

    function co(a, b, c) {
        return Array.isArray(a) ? a : "string" === typeof a ? (!(a in c) && "#" + a in c && (a = "#" + a), co(c[a], b, c)) : b
    }
    ...
    function mo(a, b) {
        var c = L({}, no, a, b);
        if (a = L(null, oo, a, b)) return b = new M(null), b.aa("XYZ", a), b.H(c), b
    }

    function po(a, b) {
        var c = L({}, no, a, b);
        if (a = L(null, oo, a, b)) return b = new E(null), b.aa("XYZ", a, [a.length]), b.H(c), b
    }

    function qo(a, b) {
        a = L([], ro, a, b);
        if (!a) return null;
        if (0 === a.length) return new Wl(a);
        var c = !0, d = a[0].S(), e;
        var f = 1;
        ...
        if (c) if ("Point" == d) {
            ...
            g.aa(c, d);
            so(g, a)
        } else "LineString" == d ? (g = new O(null), pl(g, a), so(g, a)) : "Polygon" == d ? (g = new P(null), rl(g, a), so(g, a)) : "GeometryCollection" == d ? g = new Wl(a) : wa(!1, 37); else g = new Wl(a);
        return g
    }

    function to(a, b) {
        var c = L({}, no, a, b);
        if (a = L(null, oo, a, b)) return b = new D(null), b.aa("XYZ", a), b.H(c), b
    }
    ...
    function wo(a, b) {
        ...
        c == Tn && (c = void 0);
        var d = "textStyle" in b ? b.textStyle : Wn, e = "strokeStyle" in b ? b.strokeStyle : Un;
        b = b.outline;
        void 0 === b || b || (e = null);
        return [new Ek({fill: a, image: c, stroke: e, text: d, zIndex: void 0})]
    }
    ...
    var Co = K(Zn, {displayName: I(Q), value: I(Q)}), zo = K(Zn, {
            Data: function (a, b) {
            ...
            LatLonAltBox: function (a, b) {
                if (a = L({}, Eo, a, b)) b = b[b.length - 1], b.extent = [parseFloat(a.west), parseFloat(a.south), parseFloat(a.east), parseFloat(a.north)], b.altitudeMode = a.altitudeMode, b.minAltitude = parseFloat(a.minAltitude), b.maxAltitude = parseFloat(a.maxAltitude)
            },
            Lod: function (a, b) {
                if (a = L({}, Fo, a, b)) b = b[b.length - 1], b.minLodPixels = parseFloat(a.minLodPixels), b.maxLodPixels = parseFloat(a.maxLodPixels), b.minFadeExtent = parseFloat(a.minFadeExtent), b.maxFadeExtent = parseFloat(a.maxFadeExtent)
            }
        }), Eo = K(Zn, {
            altitudeMode: I(Q),
            minAltitude: I(mm),
            ...
            east: I(mm),
            west: I(mm)
        }), Fo = K(Zn, {minLodPixels: I(mm), maxLodPixels: I(mm), minFadeExtent: I(mm), maxFadeExtent: I(mm)}),
        no = K(Zn, {extrude: I(jm), tessellate: I(jm), altitudeMode: I(Q)}), jo = K(Zn, {coordinates: Vk(fo)}),
        vo = K(Zn, {
        ...
        })), oo = K(Zn, {coordinates: Vk(fo)}), Jo = K(Zn, {href: I(go)}, K(Yn, {x: I(mm), y: I(mm), w: I(mm), h: I(mm)})),
        Ko = K(Zn, {
            Icon: I(function (a, b) {
                return (a = L({}, Jo, a, b)) ? a : null
            }), heading: I(mm), hotSpot: I(function (a) {
        ...
        Ho = K(Zn, {LinearRing: Vk(io)}), Lo = K(Zn, {color: I(eo), scale: I(ho)}),
        Mo = K(Zn, {color: I(eo), width: I(mm)}),
        ro = K(Zn, {LineString: Uk(mo), LinearRing: Uk(po), MultiGeometry: Uk(qo), Point: Uk(to), Polygon: Uk(uo)}),
        No = K(Yn, {Track: Uk(ko)}), Po = K(Zn, {
            ExtendedData: yo, Region: Ao, Link: function (a, b) {
                bl(Oo, a, b)
            }, address: I(Q), description: I(Q), name: I(Q), open: I(jm), phoneNumber: I(Q), visibility: I(jm)
        }), Oo = K(Zn, {href: I(go)}), Io = K(Zn, {LinearRing: Vk(io)}),
        Qo = K(Zn, {Style: I(wo), key: I(Q), styleUrl: I(go)}), So = K(Zn, {
            ExtendedData: yo,
            Region: Ao,
            ...
            StyleMap: function (a, b) {
                if (a = L(void 0, Ro, a, b)) b = b[b.length - 1], Array.isArray(a) ? b.Style = a : "string" === typeof a ? b.styleUrl = a : wa(!1, 38)
            },
            address: I(Q),
            description: I(Q),
            name: I(Q),
            ...
            MultiTrack: I(function (a, b) {
                if (a = L([], No, a, b)) return b = new O(null), pl(b, a), b
            }, "geometry"), Track: I(ko, "geometry")
        })),
        To = K(Zn, {color: I(eo), fill: I(jm), outline: I(jm)}), Do = K(Zn, {
            ...
            IconStyle: function (a, b) {
                if (a = L({}, Ko, a, b)) {
                    ...
                    if (g) {
                        ...
                        var m = g.nh;
                        f = g.origin
                    } else e === Qn ? (h = Mn, l = On, m = Nn) : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) && (h = [.5, 0], m = l = "fraction");
                    var n;
                    g = c.x;
                    var p = c.y;
                    ...
                    void 0 !== c && (r = Ia(c));
                    a = a.scale;
                    d ? (e == Qn && (q = Pn, void 0 === a && (a = Rn)), e = new Gn({
                        anchor: h,
                        anchorOrigin: f,
                        anchorXUnits: l,
                        anchorYUnits: m,
                ...
                if (a = L({}, To, a, b)) {
                    b = b[b.length - 1];
                    b.fillStyle = new Ck({color: "color" in a ? a.color : Kn});
                    var c = a.fill;
                    void 0 !== c && (b.fill = c);
                    a = a.outline;
    ...
    k.Rp = function (a, b) {
        ...
        null !== c && (b = wo(a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href), c = a ? (new URL("#" + c, a)).href : "#" + c, this.b[c] = b)
    };
    k.Qp = function (a, b) {
        var c = a.getAttribute("id");
        null !== c && (b = L(void 0, Ro, a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href), c = a ? (new URL("#" + c, a)).href : "#" + c, this.b[c] = b)
    };
    k.Jg = function (a, b) {
        return ha(Zn, a.namespaceURI) ? (a = this.Pg(a, [gl(this, a, b)])) ? a : null : null
    };
    k.Dc = function (a, b) {
        if (!ha(Zn, a.namespaceURI)) return [];
        var c = a.localName;
        if ("Document" == c || "Folder" == c) return (c = this.Hg(a, [gl(this, a, b)])) ? c : [];
        if ("Placemark" == c) return (b = this.Pg(a, [gl(this, a, b)])) ? [b] : [];
        if ("kml" == c) {
            c = [];
            for (a = a.firstElementChild; a; a = a.nextElementSibling) {
                var d = this.Dc(a, b);
    ...
    k.Kp = function (a) {
        if (Qk(a)) return Uo(this, a);
        if (Rk(a)) return Vo(this, a);
        if ("string" === typeof a) return a = Sk(a), Uo(this, a)
    };
    ...
    function Vo(a, b) {
        var c;
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (ha(Zn, c.namespaceURI) && "name" == c.localName) return Q(c);
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (b = c.localName, ha(Zn, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) && (b = Vo(a, c))) return b
    }

    k.Lp = function (a) {
        var b = [];
        Qk(a) ? ja(b, Wo(this, a)) : Rk(a) ? ja(b, Xo(this, a)) : "string" === typeof a && (a = Sk(a), ja(b, Wo(this, a)));
        return b
    };

    function Wo(a, b) {
        var c = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ja(c, Xo(a, b));
        return c
    }

    function Xo(a, b) {
        var c, d = [];
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (ha(Zn, c.namespaceURI) && "NetworkLink" == c.localName) {
            var e = L({}, Po, c, []);
            d.push(e)
        }
        for (c = b.firstElementChild; c; c = c.nextElementSibling) b = c.localName, !ha(Zn, c.namespaceURI) || "Document" != b && "Folder" != b && "kml" != b || ja(d, Xo(a, c));
        return d
    }

    k.Op = function (a) {
        var b = [];
        Qk(a) ? ja(b, Yo(this, a)) : Rk(a) ? ja(b, this.vf(a)) : "string" === typeof a && (a = Sk(a), ja(b, Yo(this, a)));
        return b
    };

    function Yo(a, b) {
        var c = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ja(c, a.vf(b));
        return c
    }

    k.vf = function (a) {
        var b, c = [];
        for (b = a.firstElementChild; b; b = b.nextElementSibling) if (ha(Zn, b.namespaceURI) && "Region" == b.localName) {
            var d = L({}, Bo, b, []);
            c.push(d)
        }
        for (b = a.firstElementChild; b; b = b.nextElementSibling) a = b.localName, !ha(Zn, b.namespaceURI) || "Document" != a && "Folder" != a && "kml" != a || ja(c, this.vf(b));
        return c
    };
    ...
    function $o(a, b, c) {
        ...
        if ("GeometryCollection" == d) {
            var e = b.pd();
            var f = ap
        } else "MultiPoint" == d ? (e = b.ee(), f = bp) : "MultiLineString" == d ? (e = b.qd(), f = cp) : "MultiPolygon" == d ? (e = b.Yd(), f = dp) : wa(!1, 39);
        cl(a, ep, f, e, c)
    }
    ...
    var up = K(Zn, ["Document", "Placemark"]), xp = K(Zn, {
            Document: J(function (a, b, c) {
                cl({node: a}, vp, wp, b, c, void 0, this)
            }), Placemark: J(ip)
        }), vp = K(Zn, {Placemark: J(ip)}), yp = K(Zn, {
            Data: J(function (a, b, c) {
                a.setAttribute("name", b.name);
                a = {node: a};
                b = b.value;
                "object" == typeof b ? (null !== b && b.displayName && cl(a, yp, $k, [b.displayName], c, ["displayName"]), null !== b && b.value && cl(a, yp, $k, [b.value], c, ["value"])) : cl(a, yp, $k, [b], c, ["value"])
        ...
        Bp = K(Zn, {href: J(rm)}, K(Yn, {x: J(sm), y: J(sm), w: J(sm), h: J(sm)})),
        Cp = K(Zn, ["scale", "heading", "Icon", "hotSpot"]), Ep = K(Zn, {
            Icon: J(function (a, b, c) {
                a = {node: a};
                var d = Ap[c[c.length - 1].node.namespaceURI], e = al(b, d);
                cl(a, Bp, $k, e, c, d);
                d = Ap[Yn[0]];
                e = al(b, d);
                cl(a, Bp,
                    Dp, e, c, d)
            }), heading: J(sm), hotSpot: J(function (a, b) {
                a.setAttribute("x", b.x);
                a.setAttribute("y", b.y);
                a.setAttribute("xunits", b.mh);
                a.setAttribute("yunits", b.nh)
            }), scale: J(tp)
        }), Fp = K(Zn, ["color", "scale"]), Gp = K(Zn, {color: J(Zo), scale: J(tp)}), Hp = K(Zn, ["color", "width"]),
        Ip = K(Zn, {color: J(Zo), width: J(sm)}), gp = K(Zn, {LinearRing: J(mp)}),
        ep = K(Zn, {LineString: J(mp), Point: J(mp), Polygon: J(pp), GeometryCollection: J($o)}),
        lp = K(Zn, "name open visibility address phoneNumber description styleUrl Style".split(" ")), jp = K(Zn,
        {
            ExtendedData: J(function (a, b, c) {
                a = {node: a};
                var d = b.names;
                b = b.values;
                for (var e = d.length, f = 0; f < e; f++) cl(a, yp, Jp, [{name: d[f], value: b[f]}], c)
            }),
            MultiGeometry: J($o),
            LineString: J(mp),
            LinearRing: J(mp),
            ...
            styleUrl: J(rm),
            visibility: J(qm)
        }), np = K(Zn, ["extrude", "tessellate", "altitudeMode", "coordinates"]), op = K(Zn, {
            extrude: J(qm), tessellate: J(qm), altitudeMode: J(rm), coordinates: J(function (a, b, c) {
                c = c[c.length - 1];
                var d = c.layout;
                c = c.stride;
                var e;
        ...
        }), qp = K(Zn, {outerBoundaryIs: J(fp), innerBoundaryIs: J(fp)}),
        Mp = K(Zn, {color: J(Zo)}), Kp = K(Zn, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]), Lp = K(Zn, {
            IconStyle: J(function (a, b, c) {
                a = {node: a};
                var d = {}, e = b.kc(), f = b.Ie(), g = {href: b.b.l};
                if (e) {
                    g.w = e[0];
                    g.h = e[1];
                    var h = b.Oc(), l = b.Vc();
                ...
                b = al({color: b.b, width: b.c}, d);
                cl(a, Ip, $k, b, c, d)
            }), PolyStyle: J(function (a, b, c) {
                cl({node: a}, Mp, Np, [b.b], c)
            })
        });
    ...
    function ap(a, b) {
        if (a) return Nk(b[b.length - 1].node.namespaceURI, zp[a.S()])
    }

    var Np = Yk("color"), Jp = Yk("Data"), kp = Yk("ExtendedData"), rp = Yk("innerBoundaryIs"), bp = Yk("Point"),
        cp = Yk("LineString"), hp = Yk("LinearRing"), dp = Yk("Polygon"), sp = Yk("outerBoundaryIs");
        ...
        b.prototype =
            {
                Mg: function (a, b, c) {
                    ...
                    a &= 7;
                    if (a === b.c) for (; 127 < this.pc[this.ha++];) ; else if (a === b.b) this.ha = this.Ra() + this.ha; else if (a === b.a) this.ha += 4; else if (a ===
                        b.f) this.ha += 8; else throw Error("Unimplemented type: " + a);
                }
            };
        a["default"] = b
    })(Op.Id = Op.Id || {});
    ...
    function Sp(a, b, c) {
        if (15 === a) b.version = c.Ra(); else if (1 === a) b.name = c.Tg(); else if (5 === a) b.extent = c.Ra(); else if (2 === a) b.features.push(c.ha); else if (3 === a) b.keys.push(c.Tg()); else if (4 === a) {
            a = null;
            for (var d = c.Ra() + c.ha; c.ha < d;) a = c.Ra() >> 3, a = 1 === a ? c.Tg() : 2 === a ? c.Gp() : 3 === a ? c.Cp() : 4 === a ? c.Sp() : 5 === a ? c.Ra() : 6 === a ? c.Sg() : 7 === a ? c.Ap() : null;
            b.values.push(a)
        }
    }
    ...
    function Up(a, b, c) {
        ...
        b.ha = c.geometry;
        c = b.Ra() + b.ha;
        for (var m = 1, n = 0, p = 0, q = 0, r = 0, u = 0; b.ha < c;) n || (n = b.Ra(), m = n & 7, n >>= 3), n--, 1 === m || 2 === m ? (p += b.Sg(), q += b.Sg(), 1 === m && r > u && (l.push(r), u = r), g.push(p, q), r += 2) : 7 === m ? r > u && (g.push(g[u], g[u + 1]), r += 2) : wa(!1, 59);
        r > u && l.push(r);
        b = h.length;
        var x;
        1 === d ? x = 1 === b ? "Point" : "MultiPoint" : 2 === d ? x = 1 === b ? "LineString" : "MultiLineString" : 3 === d && (x = "Polygon");
        d = x;
        if (a.b === Pp) g = new a.b(d,
            g, h, f, e); else {
            if ("Polygon" == d) {
                d = [];
                l = b = x = 0;
                for (c = h.length; l < c; ++l) m = h[l], Kf(g, x, m, 2) || (d.push(h.slice(b, l)), b = l), x = m;
                1 < d.length ? (h = d, d = new P(null)) : d = new E(null)
            } else d = "Point" === d ? new D(null) : "LineString" === d ? new M(null) : "Polygon" === d ? new E(null) : "MultiPoint" === d ? new ql(null) : "MultiLineString" === d ? new O(null) : null;
            d.aa("XY", g, h);
            g = new a.b;
            a.f && g.Zc(a.f);
    ...
    var Xp = [null], Yp = K(Xp, {
        ...
        node: function (a, b) {
            ...
            d.hi[e] = f;
            a = L({oe: {}}, Zp, a, b);
            wb(a.oe) || (f = new D(f), il(f, !1, c), c = new Kk(f), c.mc(e), c.H(a.oe), d.features.push(c))
        }, way: function (a, b) {
            var c = a.getAttribute("id");
            a = L({id: c, ud: [], oe: {}}, Yp, a, b);
    ...
    Vp.prototype.Dc = function (a, b) {
        b = gl(this, a, b);
        if ("osm" == a.localName) {
            a = L({hi: {}, jh: [], features: []}, $p, a, [b]);
            for (var c = 0; c < a.jh.length; c++) {
                for (var d = a.jh[c], e = [], f = 0, g = d.ud.length; f < g; f++) ja(e, a.hi[d.ud[f]]);
                d.ud[0] == d.ud[d.ud.length - 1] ? (f = new E(null), f.aa("XY", e, [e.length])) : (f = new M(null), f.aa("XY", e));
                il(f, !1, b);
                e = new Kk(f);
                e.mc(d.id);
                e.H(d.oe);
    ...
    bq.prototype.read = function (a) {
        return Qk(a) ? this.a(a) : Rk(a) ? this.b(a) : "string" === typeof a ? (a = Sk(a), this.a(a)) : null
    };
    ...
    var eq = [null, "http://www.opengis.net/ows/1.1"], dq = K(eq, {
    ...
    }), lq = K(eq, {Voice: I(Q), Facsimile: I(Q)}), pq = K(eq, {
        Constraint: Wk(function (a, b) {
            var c = a.getAttribute("name");
            if (c) return L({name: c}, kq, a, b)
        })
    }), rq = K(eq,
        {
        ...
        }), fq = K(eq, {Title: I(Q), ServiceTypeVersion: I(Q), ServiceType: I(Q)}), gq = K(eq, {
        ProviderName: I(Q), ProviderSite: I(aq), ServiceContact: I(function (a, b) {
            return L({}, rq, a, b)
        })
    });
    ...
    function Aq(a, b, c, d, e, f, g) {
        ...
        var h = [], l;
        var m = 0;
        for (l = a.length; m < l; ++m) h[m] = Bq(a[m], b, c, d, e, f, g);
        return h
    }
    ...
    yq.prototype.Kg = function (a, b) {
        if ("Topology" == a.type) {
            ...
            a = a.objects;
            g = this.a;
            for (var A in a) this.b && -1 == this.b.indexOf(A) || ("GeometryCollection" === a[A].type ? (l = a[A], e.push.apply(e, Aq(l, f, c, d, g, A, b))) : (l = a[A], e.push(Bq(l, f, c, d, g, A, b))));
            return e
        }
        return []
    };
    ...
    var Cq = {
        Point: function (a, b, c) {
            ...
            var c = [], d;
            var e = 0;
            for (d = a.arcs.length; e < d; ++e) c[e] = zq(a.arcs[e], b);
            return new E(c)
            ...
            if (b && c) {
                var e = 0;
                for (d = a.length; e < d; ++e) Dq(a[e], b, c)
            }
            return new ql(a)
            ...
            for (e = a.arcs.length; f < e; ++f) {
                ...
                var h = [];
                var l = 0;
                for (d = g.length; l < d; ++l) h[l] = zq(g[l], b);
                c[f] = h
            }
            return new P(c)
        }
    ...
    Eq.prototype.j = function (a) {
        if (Qk(a)) return Gq(a);
        if (Rk(a)) return L({}, Hq, a, []);
        if ("string" === typeof a) return a = Sk(a), Gq(a)
    };
    Eq.prototype.g = function (a) {
        if (Qk(a)) return Iq(this, a);
        if (Rk(a)) return Jq(this, a);
        if ("string" === typeof a) return a = Sk(a), Iq(this, a)
    };

    function Iq(a, b) {
        for (b = b.firstChild; b; b = b.nextSibling) if (b.nodeType == Node.ELEMENT_NODE) return Jq(a, b)
    }

    var Kq = {"http://www.opengis.net/gml": {boundedBy: I(hm.prototype.rf, "bounds")}};

    function Jq(a, b) {
        var c = {}, d = pm(b.getAttribute("numberOfFeatures"));
        c.numberOfFeatures = d;
        return L(c, Kq, b, [], a.b)
    }

    var Lq = {"http://www.opengis.net/wfs": {totalInserted: I(om), totalUpdated: I(om), totalDeleted: I(om)}}, Mq = {
    ...
    function Gq(a) {
        for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return L({}, Hq, a, [])
    }

    var Oq = {"http://www.opengis.net/wfs": {PropertyName: J(rm)}};

    function Pq(a, b) {
        var c = Nk("http://www.opengis.net/ogc", "Filter"), d = Nk("http://www.opengis.net/ogc", "FeatureId");
        c.appendChild(d);
        ...
        "http://www.opengis.net/wfs": {
            Insert: J(function (a, b, c) {
                ...
                if (2 === e) {
                    ...
                    for (n in h) {
                        var m = h[n];
                        null !== m && (b.push(n), l.push(m), n == g || m instanceof ef ? n in e.qb[f] || (e.qb[f][n] = J(a.ri, a)) : n in e.qb[f] || (e.qb[f][n] = J(rm)))
                    }
                    var n = tb({}, e);
                    n.node = d;
                    cl(n, e.qb, Yk(void 0, f), l, c, b)
                } else um.prototype.zi(d,
                    b, c)
                ...
                if (void 0 !== e) {
                    ...
                    cl({gmlVersion: d.gmlVersion, node: a, hasZ: d.hasZ, srsName: d.srsName}, Rq, Yk("Property"), h, c);
                    Pq(a, e)
                }
            }), Delete: J(function (a,
                                    b, c) {
                ...
                var d = Nk("http://www.opengis.net/wfs", "Name"), e = c[c.length - 1].gmlVersion;
                a.appendChild(d);
                rm(d, b.name);
                void 0 !== b.value && null !== b.value && (d = Nk("http://www.opengis.net/wfs", "Value"), a.appendChild(d), b.value instanceof ef ? 2 === e ? Dm.prototype.ri(d, b.value, c) : um.prototype.wd(d,
                    b.value, c) : rm(d, b.value))
    ...
    var Tq = {
        "http://www.opengis.net/wfs": {
            Query: J(function (a, b, c) {
                ...
                if (d = d.filter) g = Nk("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), cl({node: g}, Tq, Yk(d.nc), [d], c)
            })
        }, "http://www.opengis.net/ogc": {
            During: J(function (a, b) {
                var c = Nk("http://www.opengis.net/fes",
                    "ValueReference");
                rm(c, b.b);
                a.appendChild(c);
    ...
    Eq.prototype.v = function (a, b, c, d) {
        var e = [], f = Nk("http://www.opengis.net/wfs", "Transaction"), g = d.version ? d.version : "1.1.0",
            h = "1.0.0" === g ? 2 : 3;
        ...
        d.nativeElements && cl({
                ...
                gmlVersion: h,
                srsName: d.srsName
            }, Rq, Yk("Native"), d.nativeElements,
            e);
        return f
    };
    Eq.prototype.Qg = function (a) {
        for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return this.uf(a);
        return null
    };
    ...
    var dr = {
        Point: $q, LineString: ar, Polygon: br, MultiPoint: function (a) {
            var b = [];
            a = a.ee();
            for (var c = 0, d = a.length; c < d; ++c) b.push("(" + $q(a[c]) + ")");
            return b.join(",")
        }, MultiLineString: function (a) {
            var b = [];
            a = a.qd();
    ...
    k = Zq.prototype;
    k.he = function (a, b) {
        return (a = this.Dd(a, b)) ? (b = new Kk, b.Sa(a), b) : null
    };
    k.Lg = function (a, b) {
        var c = [];
        a = this.Dd(a, b);
        ...
        b = [];
        for (var d = 0, e = c.length; d < e; ++d) a = new Kk, a.Sa(c[d]), b.push(a);
        return b
    };
    k.Dd = function (a, b) {
        a = new er(new fr(a));
    ...
    k.lh = function (a, b) {
        if (1 == a.length) return this.se(a[0], b);
    ...
    function hr(a) {
        ...
        if (jr(a, 1)) {
            b = b.value;
            var c = "XY", d = a.b;
            1 == a.b.type && (d = d.value, "Z" === d ? c = "XYZ" : "M" === d ? c = "XYM" : "ZM" === d && (c = "XYZM"), "XY" !== c && gr(a));
            a.a = c;
            if ("GEOMETRYCOLLECTION" == b) {
                a:{
                    if (jr(a, 2)) {
                        b = [];
                        do b.push(hr(a)); while (jr(a, 5));
                        if (jr(a, 3)) {
                            a = b;
                            break a
                        }
    ...
    k.Fg = function () {
        if (jr(this, 2)) {
            var a = or(this);
            if (jr(this, 3)) return a
        } else if (kr(this)) return null;
        throw Error(lr(this));
    };
    k.Eg = function () {
        if (jr(this, 2)) {
    ...
    k.np = function () {
        if (jr(this, 2)) {
            var a;
            if (2 == this.b.type) for (a = [this.Fg()]; jr(this, 5);) a.push(this.Fg()); else a = pr(this);
            if (jr(this, 3)) return a
        } else if (kr(this)) return [];
        throw Error(lr(this));
    };
    ...
    k.op = function () {
        if (jr(this, 2)) {
            for (var a = [this.Gg()]; jr(this, 5);) a.push(this.Gg());
            if (jr(this, 3)) return a
        } else if (kr(this)) return [];
        throw Error(lr(this));
    };
    ...
    function or(a) {
        for (var b = [], c = a.a.length, d = 0; d < c; ++d) {
            var e = a.b;
            if (jr(a, 4)) b.push(e.value); else break
        }
    ...
    function pr(a) {
        for (var b = [or(a)]; jr(a, 5);) b.push(or(a));
        return b
    }

    function qr(a) {
        for (var b = [a.Eg()]; jr(a, 5);) b.push(a.Eg());
        return b
    }
    ...
    var nr = {POINT: D, LINESTRING: M, POLYGON: E, MULTIPOINT: ql, MULTILINESTRING: O, MULTIPOLYGON: P}, mr = {
    ...
    rr.prototype.b = function (a) {
        ...
        return (a = L({version: this.version}, sr, a, [])) ? a : null
    };
    ...
    function xr(a, b) {
        if (b = tr(a, b)) return a = [pm(a.getAttribute("width")), pm(a.getAttribute("height"))], b.size = a, b
    }
    ...
    var Ar = [null, "http://www.opengis.net/wms"], sr = K(Ar, {
        ...
        }), Hr = K(Ar, {ContactPerson: I(Q), ContactOrganization: I(Q)}), Ir = K(Ar, {
            AddressType: I(Q),
            Address: I(Q),
            City: I(Q),
            StateOrProvince: I(Q),
            PostCode: I(Q),
            Country: I(Q)
        }), Er = K(Ar, {Format: Uk(Q)}), Fr = K(Ar, {
            Name: I(Q), Title: I(Q), Abstract: I(Q), KeywordList: I(yr), CRS: Wk(Q),
            EX_GeographicBoundingBox: I(function (a, b) {
                ...
                if (b = tr(a, b)) return b.name = a.getAttribute("name"), b
            }), Identifier: Wk(Q), MetadataURL: Wk(function (a, b) {
                if (b = tr(a, b)) return b.type = a.getAttribute("type"), b
            }), DataURL: Wk(tr),
            FeatureListURL: Wk(tr), Style: Wk(function (a, b) {
                return L({}, Lr, a, b)
            }), MinScaleDenominator: I(mm), MaxScaleDenominator: I(mm), Layer: Wk(function (a, b) {
                var c = b[b.length - 1], d = L({}, Fr, a, b);
                if (d) return b = km(a.getAttribute("queryable")), void 0 === b && (b = c.queryable), d.queryable = void 0 !== b ? b : !1, b = pm(a.getAttribute("cascaded")), void 0 === b && (b = c.cascaded), d.cascaded = b, b = km(a.getAttribute("opaque")), void 0 === b && (b = c.opaque), d.opaque = void 0 !== b ? b : !1, b = km(a.getAttribute("noSubsets")), void 0 === b && (b = c.noSubsets), d.noSubsets =
                    void 0 !== b ? b : !1, (b = nm(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth), d.fixedWidth = b, (a = nm(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight), d.fixedHeight = a, ["Style", "CRS", "AuthorityURL"].forEach(function (a) {
        ...
        }), Kr = K(Ar, {Title: I(Q), OnlineResource: I(aq), LogoURL: I(xr)}), Jr = K(Ar, {
            westBoundLongitude: I(mm),
            eastBoundLongitude: I(mm), southBoundLatitude: I(mm), northBoundLatitude: I(mm)
        }), Dr = K(Ar, {GetCapabilities: I(vr), GetMap: I(vr), GetFeatureInfo: I(vr)}), wr = K(Ar, {
            Format: Wk(Q), DCPType: Wk(function (a, b) {
                return L({}, Mr, a, b)
            })
        }), Mr = K(Ar, {
            HTTP: I(function (a, b) {
        ...
        }), Nr = K(Ar, {Get: I(tr), Post: I(tr)}),
        Lr = K(Ar, {Name: I(Q), Title: I(Q), Abstract: I(Q), LegendURL: Wk(xr), StyleSheetURL: I(tr), StyleURL: I(tr)}),
        ur = K(Ar, {Format: I(Q), OnlineResource: I(aq)}), zr = K(Ar, {Keyword: Uk(Q)});
    ...
    var Sr = [null, "http://www.opengis.net/wmts/1.0"], Tr = [null, "http://www.opengis.net/ows/1.1"], Qr = K(Sr, {
            ...
            Style: Wk(function (a, b) {
                if (b = L({}, Xr, a, b)) return a = "true" === a.getAttribute("isDefault"), b.isDefault = a, b
            }), Format: Wk(Q), TileMatrixSetLink: Wk(function (a, b) {
                return L({}, Yr, a, b)
        ...
        }, K(Tr, {Title: I(Q), Identifier: I(Q)})), Yr = K(Sr, {
        ...
        }), bs = K(Sr, {TileMatrix: I(Q), MinTileRow: I(om), MaxTileRow: I(om), MinTileCol: I(om), MaxTileCol: I(om)}),
        Zr = K(Sr, {Default: I(Q), Value: Wk(Q)}, K(Tr, {Identifier: I(Q)})),
        $r = K(Tr, {LowerCorner: Uk(Rr), UpperCorner: Uk(Rr)}), Wr = K(Sr, {
            WellKnownScaleSet: I(Q), TileMatrix: Wk(function (a, b) {
                return L({}, cs, a, b)
            })
        }, K(Tr, {SupportedCRS: I(Q), Identifier: I(Q)})), cs = K(Sr, {
            TopLeftCorner: I(Rr), ScaleDenominator: I(mm), TileWidth: I(om), TileHeight: I(om), MatrixWidth: I(om),
            MatrixHeight: I(om)
        }, K(Tr, {Identifier: I(Q)}));
    ...
    k.Mm = function () {
        if (td) {
            var a = this.ki();
            a && void 0 === this.c ? this.c = navigator.geolocation.watchPosition(this.vp.bind(this), this.wp.bind(this), this.Xh()) : a || void 0 === this.c || (navigator.geolocation.clearWatch(this.c), this.c = void 0)
        }
    };
    k.vp = function (a) {
        a = a.coords;
    ...
    k.Ya = function (a) {
        var b = this.G();
        return qb(a, b) ? (b = this.xa(), a[0] <= b[0] && a[2] >= b[0] || a[1] <= b[1] && a[3] >= b[1] ? !0 : eb(a, this.yb, this)) : !1
    };
    k.rb = function (a) {
    ...
    function gs(a, b, c) {
        for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f, e], m = [h, g], n = [1, 0], p = {}, q = 1E5, r, u, x, B, A; 0 < --q && 0 < n.length;) x = n.pop(), e = l.pop(), g = m.pop(), f = x.toString(), f in p || (d.push(g[0], g[1]), p[f] = !0), B = n.pop(), f = l.pop(), h = m.pop(), A = (x + B) / 2, r = a(A), u = b(r), Ga(u[0], u[1], g[0], g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), f = B.toString(), p[f] = !0) : (n.push(B, A, A, x), m.push(h, u, u, g), l.push(f, r, r, e));
        return d
    }
    ...
    function ks(a) {
        ...
        1 == a.showLabels && (this.ta = a.lonLabelFormatter ? a.lonLabelFormatter : Be.bind(this, "EW"), this.Ua = a.latLabelFormatter ? a.latLabelFormatter : Be.bind(this, "NS"), this.fa =
            void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.U = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition, this.B = void 0 !== a.lonLabelStyle ? a.lonLabelStyle : new Hn({
            font: "12px Calibri,sans-serif",
            textBaseline: "bottom",
            fill: new Ck({color: "rgba(0,0,0,1)"}),
            stroke: new Dk({color: "rgba(255,255,255,1)", width: 3})
    ...
    var ls = new Dk({color: "rgba(0,0,0,0.2)"}),
    ...
    function ns(a, b, c, d, e, f, g) {
        ...
        h.aa("XY", c);
        qb(h.G(), f) && (a.b && (c = g, d = h.ca(), f = [d[0], Da(f[1] + Math.abs(f[1] - f[3]) * a.fa, Math.max(f[1], d[1]), Math.min(f[3], d[d.length - 1]))], c = a.b[c] ? a.b[c].Ud : new D(null), c.na(f), a.b[g] = {
            Ud: c,
            text: a.ta(b)
        }), a.f[g++] = h);
        return g
    ...
    function os(a, b, c, d, e, f, g) {
        ...
        h.aa("XY", c);
        qb(h.G(), f) && (a.a && (c = g, d = h.ca(), f = [Da(f[0] + Math.abs(f[0] - f[2]) * a.U, Math.max(f[0], d[0]), Math.min(f[2], d[d.length - 2])), d[1]], c = a.a[c] ? a.a[c].Ud : new D(null), c.na(f), a.a[g] = {
            Ud: c,
            text: a.Ua(b)
        }), a.c[g++] = h);
        return g
    ...
    k.ai = function (a) {
        ...
        if (!this.i || !hc(this.i, f)) {
            var g = Zb("EPSG:4326"), h = f.G(), l = f.re, m = lc(l, g, f), n = l[2], p = l[1], q = l[0], r = m[3],
                u = m[2], x = m[1];
            m = m[0];
            this.g = l[3];
            this.j = n;
        ...
        if (-1 == d) this.f.length = this.c.length = 0, this.b && (this.b.length = 0), this.a && (this.a.length = 0); else {
            ...
            for (l = 0; u != this.o &&
            l++ < g;) u = Math.max(u - d, this.o), n = ns(this, u, q, p, c, a, n);
            u = Da(e, this.o, this.j);
            for (l = 0; u != this.j && l++ < g;) u = Math.min(u + d, this.j), n = ns(this, u, q, p, c, a, n);
            this.f.length = n;
            this.b && (this.b.length = n);
            f = Math.floor(f / d) * d;
            e = Da(f, this.l, this.g);
            n = os(this, e, r, h, c, a, 0);
            for (l = 0; e != this.l && l++ < g;) e = Math.max(e - d, this.l), n = os(this, e, r, h, c, a, n);
            e = Da(f, this.l, this.g);
            for (l = 0; e != this.g && l++ < g;) e = Math.min(e + d, this.g), n = os(this, e, r, h, c, a, n);
            this.c.length = n;
        ...
        c; ++a) e = this.f[a], b.Fb(e);
        a = 0;
        for (c = this.c.length; a < c; ++a) e = this.c[a], b.Fb(e);
        if (this.b) for (a = 0, c = this.b.length; a < c; ++a) e = this.b[a], this.B.Ed(e.text), b.ib(this.B), b.Fb(e.Ud);
        if (this.a) for (a = 0, c = this.a.length; a < c; ++a) e = this.a[a], this.D.Ed(e.text), b.ib(this.D), b.Fb(e.Ud)
    };
    k.setMap = function (a) {
        this.v && (this.v.K("postcompose", this.ai, this), this.v.render());
    ...
    k.load = function () {
        if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.f = [Mc(this.N, "error", this.Qm, this), Mc(this.N, "load", this.Rm, this)], this.i(this, this.g)
    };
    k.gh = function (a) {
        this.N = a
    };
    ...
    rs.prototype.load = function () {
        0 == this.state && (this.state = 1, this.u(), this.i(this.g.bind(this)))
    };
    ...
    k = us.prototype;
    k.ka = function () {
        1 == this.state && (vs(this), this.N.src = ws);
        this.f && Qc(this.f);
        this.state = 5;
        this.u();
    ...
    k.load = function () {
        if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.c = [Mc(this.N, "error", this.Om, this), Mc(this.N, "load", this.Pm, this)], this.l(this, this.g)
    };
    ...
    ys.prototype.l = function (a, b) {
        ...
        this.g && (this.g.clear(), this.g.Ic(e));
        this.b(new Bs(Cs, a, e, d))
    };

    function Ds(a) {
        var b = a.v;
        b && (b = a.target ? a.target : b.a, a.a = [z(b, "drop", zs, a), z(b, "dragenter", As, a), z(b, "dragover", As, a), z(b, "drop", As, a)])
    }
    ...
    function Fs(a) {
        a = a ? a : {};
        Tg.call(this, {handleDownEvent: Gs, handleDragEvent: Hs, handleUpEvent: Is});
    ...
    function Hs(a) {
        if (Rg(a)) {
            var b = a.map, c = b.zb(), d = a.pixel;
            a = d[0] - c[0] / 2;
            d = c[1] / 2 - d[1];
            c = Math.atan2(d, a);
            a = Math.sqrt(a * a + d * d);
            b = b.$();
            b.g.rotation !== se && void 0 !== this.g && (d = c - this.g, Eg(b, b.Pa() - d));
            this.g = c;
            void 0 !== this.a && (c = this.a * (b.Oa() / a), Gg(b, c));
    ...
    (function (a) {
        ...
        function x(a, b, c, d, e) {
            for (var f = [b, c], g; f.length;) c = f.pop(), b = f.pop(), c - b <= d || (g = b + Math.ceil((c - b) / d / 2) * d, B(a, g, b, c, e), f.push(b,
                g, g, c))
        }
        ...
        e.prototype = {
            all: function () {
                ...
                var b = this.data, c = [], d = this.Db;
                if (!r(a, b)) return c;
                for (var e = [], f, g, h, l; b;) {
                    f = 0;
                    for (g = b.children.length; f < g; f++) h = b.children[f], l = b.nb ? d(h) : h, r(a, l) && (b.nb ? c.push(h) : q(a, l) ? this.ph(h, c) : e.push(h));
                    b = e.pop()
                }
                return c
            }, load: function (a) {
                ...
                this.data.children.length ?
                    this.data.height === a.height ? this.wh(this.data, a) : (this.data.height < a.height && (b = this.data, this.data = a, a = b), this.th(a, this.data.height - a.height - 1, !0)) : this.data = a;
                return this
            }, Ea: function (a) {
                ...
                e.children.push(a);
                for (h(e, c); 0 <= b;) if (d[b].children.length > this.Lf) this.vk(d, b), b--; else break;
                this.lk(c, d, b)
            }, vk: function (a, b) {
                var c = a[b], d = c.children.length, e = this.uh;
                this.mk(c, e, d);
                d = this.nk(c, e, d);
                ...
                var d = a.nb ? this.Pf :
                    l, e = a.nb ? this.Qf : m, f = this.qh(a, b, c, d);
                b = this.qh(a, b, c, e);
                ...
                for (var b = a.length - 1, c; 0 <= b; b--) 0 === a[b].children.length ? 0 < b ? (c = a[b - 1].children, c.splice(c.indexOf(a[b]), 1)) : this.clear() : f(a[b],
                    this.Db)
            }, sk: function (a) {
                var b = ["return a", " - b", ";"];
    ...
    function S(a) {
        ...
        this.I = a.url;
        a.loader ? this.s = a.loader : void 0 !== this.I && (wa(this.B, 7), this.s = el(this.I, this.B));
    ...
    k.Eb = function (a) {
        ...
        if (Vs(this, b, a)) {
            Ws(this, b, a);
            var c = a.W();
            c ? (b = c.G(), this.a && this.a.Ea(b, a)) : this.g[b] = a;
    ...
    function Ts(a, b) {
        ...
        g = 0;
        for (c = e.length; g < c; g++) h = e[g], l = w(h).toString(), Ws(a, l, h), (b = h.W()) ? (l = b.G(), d.push(l), f.push(h)) : a.g[l] = h;
        a.a && a.a.load(d, f);
        g = 0;
        for (c = e.length; g < c; g++) a.b(new Xs("addfeature", e[g]))
    }
    ...
    function Us(a, b) {
        ...
        z(b, "add", function (a) {
            c || (c = !0, this.Eb(a.element), c = !1)
        }, a);
        z(b, "remove", function (a) {
            c || (c = !0, this.Ib(a.element), c = !1)
        }, a);
        a.i = b
    }
    ...
    k.clear = function (a) {
        if (a) {
            ...
            for (var c in this.g) this.Wg(this.g[c])
        }
        this.i && this.i.clear();
        this.a && this.a.clear();
        this.T.clear();
    ...
    function Ys(a, b, c) {
        a.ac([b[0], b[1], b[0], b[1]], function (a) {
            if (a.W().yb(b)) return c.call(void 0, a)
        })
    }

    k.ac = function (a, b, c) {
        if (this.a) return Ss(this.a, a, b, c);
    ...
    k.fe = function () {
        if (this.i) var a = this.i.a; else this.a && (a = Ps(this.a), wb(this.g) || ja(a, vb(this.g)));
        return a
    };
    k.Ph = function (a) {
        var b = [];
    ...
    k.aj = function (a) {
        ...
        c ? (c = c.G(), b in this.g ? (delete this.g[b], this.a && this.a.Ea(c, a)) : this.a && Os(this.a, c, a)) : b in this.g || (this.a && this.a.remove(a), this.g[b] = a);
        c = a.c;
        void 0 !== c ? (c = c.toString(), b in this.o ? (delete this.o[b], this.l[c] = a) : this.l[c] !== a && (Zs(this, a), this.l[c] = a)) : b in this.o || (Zs(this, a), this.o[b] = a);
        this.u();
    ...
    function $s(a) {
        Tg.call(this, {handleDownEvent: at, handleEvent: bt, handleUpEvent: ct});
        this.U = !1;
        this.fa = null;
        this.s = !1;
        ...
        this.ma = new R({
            source: new S({useSpatialIndex: !1, wrapX: a.wrapX ? a.wrapX : !1}),
            style: a.style ? a.style : ht()
        });
        this.ub = a.geometryName;
        this.Gk = a.condition ? a.condition : Og;
        this.If = a.freehand ? Pe : a.freehandCondition ? a.freehandCondition :
            Pg;
    ...
    function bt(a) {
        ...
        var b = !0;
        this.s && "pointerdrag" === a.type && null !== this.j ? (it(this, a), b = !1) : this.s && "pointerdown" === a.type ? b = !1 : "pointermove" === a.type ? b = jt(this, a) : "dblclick" === a.type && (b = !1);
        return Ug.call(this, a) && b
    }

    function at(a) {
        this.U = !this.s;
        return this.s ? (this.fa = a.pixel, this.o || kt(this, a), !0) : this.Gk(a) ? (this.fa = a.pixel, !0) : !1
    }
    ...
    function ct(a) {
        ...
        jt(this, a);
        var c = this.g === lt;
        this.U ? (this.o ? this.s || c ? this.Td() : mt(this, a) ? this.Jd(a) && this.Td() : it(this, a) : (kt(this, a), this.g === ft && this.Td()), b = !1) : this.s && (this.o = null, nt(this));
        return b
    }
    ...
    function mt(a, b) {
        ...
        if (a.j) {
            var d = !1, e = [a.o];
            a.g === gt ? d = a.a.length > a.Va : a.g === et && (d = a.a[0].length > a.Va, e = [a.a[0][0], a.a[0][a.a[0].length - 2]]);
            if (d) {
                d = b.map;
    ...
    function kt(a, b) {
        b = b.coordinate;
        a.o = b;
        a.g === ft ? a.a = b.slice() : a.g === et ? (a.a = [[b.slice(), b.slice()]], a.I = a.a[0]) : (a.a = [b.slice(), b.slice()], a.g === lt && (a.I = a.a));
    ...
    function it(a, b) {
        ...
        if (a.g === gt) {
            ...
            e.push(b.slice());
            a.Za(e, c)
        } else a.g === et && (e = a.a[0], e.length >= a.oa && (a.s ? e.pop() : d = !0), e.push(b.slice()), d && (a.o = e[0]), a.Za(a.a, c));
        ot(a);
        d && a.Td()
    }
    ...
    k.Td = function () {
        var a = nt(this), b = this.a, c = a.W();
        this.g === gt ? (b.pop(), this.Za(b, c)) : this.g === et && (b[0].pop(), this.Za(b, c), b = c.V());
    ...
    function nt(a) {
        a.o = null;
        var b = a.j;
        b && (a.j = null, a.B = null, a.D = null, a.ma.ia().clear(!0));
        return b
    }
    ...
    var ft = "Point", gt = "LineString", et = "Polygon", lt = "Circle";
    ...
    function qt(a) {
        ...
        this.B = this.o = null;
        a || (a = {});
        Tg.call(this, {handleDownEvent: rt, handleDragEvent: st, handleEvent: tt, handleUpEvent: ut});
        this.s = new R({
            source: new S({useSpatialIndex: !1, wrapX: !!a.wrapX}),
    ...
    function tt(a) {
        ...
        if ("pointermove" == a.type && !this.C) {
            var b = a.pixel, c = a.map, d = xt(this, b, c);
            d || (d = c.Na(b));
            yt(this, d)
        }
        Ug.call(this, a);
    ...
    function rt(a) {
        ...
        (a = xt(this, c, d)) && e ? (c = a[0] == e[0] || a[0] == e[2] ? a[0] : null, d = a[1] == e[1] || a[1] == e[3] ? a[1] : null, null !== c && null !== d ? this.a = zt(b(a)) : null !== c ? this.a = At(b([c, e[1]]), b([c, e[3]])) : null !== d && (this.a = At(b([e[0], d]), b([e[2], d])))) : (a = d.Na(c), this.g([a[0], a[1], a[0], a[1]]), this.a = zt(a));
        return !0
    }

    function st(a) {
        this.a && (a = a.coordinate, this.g(this.a(a)), yt(this, a));
        return !0
    }
    ...
    function xt(a, b, c) {
        ...
        if (f) {
            ...
            f.sort(d);
            f = f[0];
            var g = Ae(e, f), h = c.Ha(g);
            if (10 >= He(b, h)) return b = c.Ha(f[0]), c = c.Ha(f[1]), b = Ge(h, b), c = Ge(h, c), a.D = 10 >= Math.sqrt(Math.min(b, c)), a.D && (g = b > c ? f[1] : f[0]), g
        }
        return null
    }
    ...
    function yt(a, b) {
        var c = a.B;
        c ? c.W().na(b) : (c = new Kk(new D(b)), a.B = c, a.I.ia().Eb(c))
    }
    ...
    qt.prototype.g = function (a) {
        this.j = a ? a : null;
        var b = this.o;
        b ? a ? b.Sa(Rf(a)) : b.Sa(void 0) : (this.o = b = a ? new Kk(Rf(a)) : new Kk({}), this.s.ia().Eb(b));
    ...
    function Ct(a) {
        Tg.call(this, {handleDownEvent: Dt, handleDragEvent: Et, handleEvent: Ft, handleUpEvent: Gt});
        ...
        this.j = [];
        this.B = new R({
            source: new S({useSpatialIndex: !1, wrapX: !!a.wrapX}), style: a.style ?
                a.style : Ht(), updateWhileAnimating: !0, updateWhileInteracting: !0
        });
        this.fa = {
            Point: this.Nn,
            LineString: this.Ji,
        ...
        this.U = null;
        a.source ? (this.U = a.source, a = new C(this.U.fe()), z(this.U, "addfeature", this.bm, this), z(this.U, "removefeature", this.dm, this)) : a = a.features;
        if (!a) throw Error("The modify interaction requires features or a source");
        this.s = a;
        this.s.forEach(this.wg,
            this);
    ...
    function Jt(a, b) {
        a.D || (a.D = !0, a.b(new Kt("modifystart", a.s, b)))
    }

    function Lt(a, b) {
        Mt(a, b);
        a.g && 0 === a.s.gc() && (a.B.ia().Ib(a.g), a.g = null);
        Nc(b, "change", a.Ii, a)
    }
    ...
    k.Ga = function (a) {
        this.g && !a && (this.B.ia().Ib(this.g), this.g = null);
    ...
    k.Ii = function (a) {
        this.o || (a = a.target, Lt(this, a), this.wg(a))
    };
    k.Hn = function (a) {
        Lt(this, a.element)
    };
    ...
    function Nt(a, b) {
        var c = a.g;
        c ? c.W().na(b) : (c = new Kk(new D(b)), a.g = c, a.B.ia().Eb(c))
    }
    ...
    function Dt(a) {
        ...
        if (c) {
            ...
            for (var g = 0, h = e.length; g < h; ++g) {
                ...
                p && (n += "-" + p.join("-"));
                f[n] || (f[n] = Array(2));
                if ("Circle" === l.geometry.S() && 1 === l.index) m = Pt(b, l), De(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n][0] = l); else if (De(m[0], c) && !f[n][0]) this.j.push([l, 0]), f[n][0] = l; else if (De(m[1], c) &&
                    !f[n][1]) {
            ...
            d.length && Jt(this, a);
            for (a = d.length - 1; 0 <= a; --a) this.km.apply(this, d[a])
        }
        return !!this.g
    }
        ...
        for (var b = 0, c = this.j.length; b < c; ++b) {
            ...
            switch (g.S()) {
                ...
                case "MultiPolygon":
                    ...
                    break;
                case "Circle":
                    h[0] = h[1] = a, 0 === e.index ? (this.o = !0, g.rb(a)) : (this.o = !0, g.$c(He(g.xa(), a))), this.o = !1
            }
    ...
    function Gt(a) {
        for (var b, c, d = this.j.length - 1; 0 <= d; --d) if (b = this.j[d][0], c = b.geometry, "Circle" === c.S()) {
            ...
            Os(this.a, $a(e), f);
            Os(this.a, c.G(), b)
        } else Os(this.a, Oa(b.la), b);
        this.D && (this.b(new Kt("modifyend", this.s, a)), this.D = !1);
        return !1
    }
    ...
    function Ft(a) {
        ...
        this.T = a;
        var b;
        Yf(a.map.$())[1] || "pointermove" != a.type || this.C || (this.Va = a.pixel, It(this, a.pixel, a.map));
    ...
    function It(a, b, c) {
        ...
        var e = c.Na(b), f = Ra($a(e), c.$().Oa() * a.ma);
        f = Qs(a.a, f);
        if (0 < f.length) {
            f.sort(d);
            var g = f[0], h = g.la, l = Pt(e, g), m = c.Ha(l), n = He(b, m);
            if (n <= a.ma) {
                b = {};
                if ("Circle" === g.geometry.S() && 1 === g.index) a.oa = !0, Nt(a, l); else for (n = c.Ha(h[0]), g = c.Ha(h[1]), c = Ge(m, n), m = Ge(m, g), n = Math.sqrt(Math.min(c, m)), a.oa = n <= a.ma, a.oa && (l = c > m ? h[1] : h[0]), Nt(a, l), m = 1, c = f.length; m < c; ++m) if (l = f[m].la, De(h[0], l[0]) && De(h[1], l[1]) || De(h[0], l[1]) && De(h[1], l[0])) b[w(l)] = !0; else break;
                b[w(h)] = !0;
                a.ab = b;
                return
            }
        }
        a.g && (a.B.ia().Ib(a.g), a.g = null)
    }

    function Qt(a, b) {
        var c = b.geometry;
        return "Circle" === c.S() && 1 === b.index ? (a = Ge(c.xa(), a), c = Math.sqrt(a) - c.xd(), c * c) : Ie(a, b.la)
    }
    ...
    k.km = function (a, b) {
        for (var c = a.la, d = a.feature, e = a.geometry, f = a.depth, g = a.index, h; b.length < e.pa();) b.push(0);
        switch (e.S()) {
            case "MultiLineString":
                h = e.V();
        ...
        if (this.T && "pointerdrag" != this.T.type) {
            ...
            for (h in c) {
                ...
                q && (q = f, this.o = !0, q.na(d), this.o = !1, d = [], void 0 !== m && (this.a.remove(m), d.push(m.la[0])), void 0 !== l && (this.a.remove(l), d.push(l.la[1])), void 0 !== m && void 0 !== l && (m = {
                    ...
                    m)), Rt(this, f, e, g.depth, -1), this.g && (this.B.ia().Ib(this.g), this.g = null), b.length = 0)
            }
    ...
    function St(a) {
        ...
        this.g = new R({
            source: new S({useSpatialIndex: !1, features: a.features, wrapX: a.wrapX}),
    ...
    function Tt(a) {
        ...
        var b = this.C(a), c = this.B(a), d = this.I(a), e = !b && !c && !d, f = a.map, g = this.g.ia().i, h = [],
            l = [];
        if (e) {
            ub(this.a);
    ...
    function Xt(a) {
        Tg.call(this, {handleEvent: Yt, handleDownEvent: Pe, handleUpEvent: Zt});
        a = a ? a : {};
    ...
    k.Ki = function (a) {
        if (a instanceof Xs) var b = a.feature; else a instanceof dd && (b = a.element);
        this.Eb(b)
    };
    k.Li = function (a) {
        if (a instanceof Xs) var b = a.feature; else a instanceof dd && (b = a.element);
    ...
    k.setMap = function (a) {
        ...
        b && (c.forEach(Hc), c.length = 0, d.forEach(this.Mk, this));
        Tg.prototype.setMap.call(this, a);
        a && (this.j ? c.push(z(this.j, "add", this.Ki, this), z(this.j, "remove", this.Li, this)) : this.o && c.push(z(this.o, "addfeature", this.Ki, this), z(this.o, "removefeature", this.Li, this)), d.forEach(this.Lk, this))
    };
    k.cd = Qe;

    function au(a, b, c, d) {
        var e = d.Na([b[0] - a.g, b[1] + a.g]), f = d.Na([b[0] + a.g, b[1] - a.g]);
        e = Oa([e, f]);
        var g = Qs(a.a, e);
        ...
        if (0 < g.length) {
            ...
            if (a.T && !a.D) {
                if (c = d.Ha(m[0]), h = d.Ha(m[1]), c = Ge(b, c), b = Ge(b, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.g) e = !0, f = c > b ? m[1] : m[0], l = d.Ha(f)
            } else a.D && (f = h ? ze(c, g[0].feature.W()) : Ae(c, m), l = d.Ha(f), He(b, l) <= a.g && (e = !0, a.T &&
            !h && (c = d.Ha(m[0]), h = d.Ha(m[1]), c = Ge(l, c), b = Ge(l, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.g))) && (f = c > b ? m[1] : m[0], l = d.Ha(f));
            e && (l = [Math.round(l[0]), Math.round(l[1])])
        }
        return {qq: e, vertex: f, zq: l}
    }
    ...
    function Yt(a) {
        ...
        b.qq && (a.coordinate = b.vertex.slice(0, 2), a.pixel = b.zq);
        return Ug.call(this, a)
    }

    function Zt() {
        var a = vb(this.s);
        a.length && (a.forEach(this.Sj, this), this.s = {});
        return !1
    }
    ...
    function eu(a) {
        var b = a.map.a;
        gu(this, a.pixel, a.map) ? (b.classList.remove(this.a ? "ol-grab" : "ol-grabbing"), b.classList.add(this.a ? "ol-grabbing" : "ol-grab")) : b.classList.remove("ol-grab", "ol-grabbing")
    }
    ...
    function V(a) {
        ...
        this.j(function (a) {
            ...
            c || (c = [new Ek({image: new Gn({opacity: a, src: this.B})})], this.v[b] = c);
            return c
        }.bind(this));
        this.set(Bj, null);
    ...
    k.Jl = function () {
        for (var a = this.Rh(), b = dg(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f = a.length; e < f; ++e) c.addColorStop(e * d, a[e]);
        b.fillStyle = c;
        b.fillRect(0, 0, 1, 256);
        this.c = b.getImageData(0, 0, 1, 256).data
    };
    k.mg = function () {
        var a = this.Oi(), b = this.Kh(), c = a + b + 1, d = 2 * c;
        d = dg(d, d);
    ...
    var lu = "blur", ju = "gradient", mu = "radius";
    ...
    xu.prototype.Ka = function (a, b, c, d, e, f, g, h, l, m, n) {
        ...
        p.uniform1f(f.a, g);
        if (l) {
            m ? a = this.He(p, a, h, l, n) :
                (p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT), this.Sd(p, a, h, !0), a = (a = l(null)) ? a : void 0);
            var la = a
        } else this.Sd(p, a, h, !1);
        this.Cf(p, f);
        this.g && (q || p.disable(p.STENCIL_TEST), p.clear(p.STENCIL_BUFFER_BIT), p.stencilFunc(r, x, u), p.stencilMask(B), p.stencilOp(A, N, y));
        return la
    };
    ...
    k.Bf = function (a, b, c, d) {
        var e = Ju(b, su, tu);
        if (this.v) var f = this.v; else this.v = f = new uu(a, e);
        b.Wc(e);
    ...
    k.He = function (a, b, c, d, e) {
        ...
        for (f = this.s.length - 1; 0 <= f; --f) {
            ...
            for (g = this.s[f]; 0 <= h && this.f[h] >= g;) {
                ...
                var n = this.i[h];
                var p = w(n).toString();
                if (void 0 === c[p] && n.W() && (void 0 === e || qb(e, n.W().G())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), zu(a, b, m, l), l = d(n))) return l;
                h--;
                l = m
            }
        }
    ...
    function Pu(a) {
        if (!a.i) {
            ...
            var d = Qu(b, 1, 1), e = b.createRenderbuffer();
    ...
    function Vu(a, b, c, d) {
        var e = a.C, f = a.D, g = a.height, h = a.ra, l = a.sa, m = a.opacity, n = a.I, p = a.T,
    ...
    k.Bf = function (a, b) {
        var c = Ju(b, Lu, Mu);
        if (this.Ua) var d = this.Ua; else this.Ua = d = new Nu(a, c);
        b.Wc(c);
    ...
    k.Sd = function (a, b, c, d) {
        ...
        if (wb(c)) {
            ...
            for (var l = 0 < f ? d[f - 1] : 0, m = d[f], n = l; g < this.f.length && this.f[g] <= m;) {
                ...
                void 0 !== c[p] ? (n !== l && zu(a, b, n, l), l = n = g === this.f.length - 1 ? m : this.f[g + 1]) : l = g === this.f.length - 1 ? m : this.f[g + 1];
                g++
            }
            n !== l && zu(a, b, n, l)
        }
    ...
    k.He = function (a, b, c, d, e) {
        ...
        for (f = l.length - 1; 0 <= f; --f) {
            ...
            for (g = this.s[f]; 0 <= h && this.f[h] >= m;) {
                ...
                var p = this.i[h];
                var q = w(p).toString();
                if (void 0 === c[q] && p.W() && (void 0 === e || qb(e, p.W().G())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), zu(a, b, n, g), g = d(p))) return g;
                g = n;
                h--
            }
        }
    ...
    k.Wb = function (a) {
        var b = a.Oc(), c = a.Y(1), d = a.Ie(), e = a.Cg(1), f = a.i, g = a.Vc(), h = a.o, l = a.g, m = a.kc();
        a = a.a;
    ...
    function bv(a, b, c, d) {
        var e, f = a.a.length, g = a.b.length, h = "bevel" === a.c.lineJoin ? 0 : "miter" === a.c.lineJoin ? 1 : 2,
            l = "butt" === a.c.lineCap ? 0 : "square" === a.c.lineCap ? 1 : 2, m = js(b, c, d), n = g, p = 1;
        for (e = 0; e < c; e += d) {
            var q = f / 7;
            var r = u;
            var u = x || [b[e], b[e + 1]];
            if (0 === e) {
                ...
                if (m) {
                    ...
                    l && (f = cv(a, [0, 0], u, x, p * dv * l, f), f = cv(a, [0, 0], u, x, -p * dv * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2);
                    f = cv(a, [0, 0], u, x, p * ev *
                        (l || 1), f);
                ...
                m ? x = B : (r = r || [0, 0], f = cv(a, r, u, [0, 0], p * fv * (l || 1), f), f = cv(a, r, u, [0, 0], -p * fv * (l || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f = cv(a, r, u, [0, 0], p * gv * l, f), f = cv(a, r, u, [0, 0], -p * gv * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2));
                break
            ...
            n = q + 2;
            p = A;
            h && (f = cv(a, r, u, x, A * kv * h, f), a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q)
        }
        m && (q = q || f / 7, A = Kf([r[0], r[1], u[0], u[1], x[0], x[1]], 0, 6, 2) ? 1 : -1, f = cv(a, r, u, x, A * hv * (h || 1), f), cv(a, r, u, x, -A * jv * (h || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, a.b[g++] = 0 < p * A ? n : n - 1)
    }
    ...
    k.qc = function (a, b) {
        var c = a.ca();
        a = a.pa();
        lv(c, 0, c.length, a) && (c = Se(c, 0, c.length, a, -this.origin[0], -this.origin[1]), this.c.u && (this.l.push(this.b.length), this.c.u = !1), this.f.push(this.b.length), this.i.push(b), bv(this, c, c.length, a))
    };
    k.rc = function (a, b) {
        ...
        if (1 < d.length) {
            var g = 1;
            for (f = d.length; g < f; ++g) if (lv(e, d[g - 1], d[g], a)) {
                var h = Se(e, d[g - 1], d[g], a, -this.origin[0], -this.origin[1]);
                bv(this, h, h.length, a)
            }
        }
        this.b.length > c && (this.f.push(c), this.i.push(b), this.c.u && (this.l.push(c), this.c.u = !1))
    };

    function mv(a, b, c, d) {
        js(b, b.length, d) || (b.push(b[0]), b.push(b[1]));
        bv(a, b, b.length, d);
        if (c.length) {
            var e;
            b = 0;
            for (e = c.length; b < e; ++b) js(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])), bv(a, c[b], c[b].length, d)
        }
    }
    ...
    k.Bf = function (a, b, c, d) {
        var e = Ju(b, Yu, Zu);
        if (this.v) var f = this.v; else this.v = f = new $u(a, e);
        b.Wc(e);
        ...
        if (wb(c)) {
            ...
            for (h = this.l.length - 1; 0 <= h; --h) {
                ...
                for (n = this.l[h]; 0 <= m && this.f[m] >= n;) {
                    ...
                    var q = this.i[m];
                    q = w(q).toString();
                    c[q] && (g !== l && (zu(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT)), l = p);
                    m--;
                    g = p
                }
                g !== l && (zu(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT));
                g = l = n
            }
        }
    ...
    var ev = 3, fv = 5, dv = 7, gv = 11, hv = 13, iv = 17, jv = 19, kv = 23;
    ...
    function tv(a) {
        ...
        if (b) {
            ...
            d && (d.next = c);
            a.b = c || d;
            a.f === a.a ? (a.b = void 0, a.f = void 0, a.a = void 0) : a.f === b ? a.f = a.b : a.a === b && (a.a = d ? a.b.Bb : a.b);
            a.c--
        }
    }
    ...
    function xv(a) {
        if (a.b && a.b.Bb) return a.b = a.b.Bb, a.b.data
    }

    function yv(a) {
        if (a.b && a.b.Bb) return a.b.Bb.data
    }
    ...
    function Bv(a, b, c, d) {
        ...
        if (c.length) {
            ...
            for (g = c.length; l < g; ++l) {
                var m = {list: new sv, yc: void 0, eh: new Ns};
                h.push(m);
            ...
            for (l = 0; l < h.length; ++l) {
                ...
                !n && Gv(c, h[l].yc[0], e, b[0], f) && (f.concat(h[l].eh), Ev(e, f, !1))
            }
        } else Ev(e, f, !1);
        Hv(a,
            e, f)
    ...
    function Cv(a, b, c, d, e, f) {
        ...
        } else for (p = b.length - c, n = f = Iv(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c) q = Iv(a, b[p], b[p + 1], h++), m.push(Jv(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]), n = q;
        m.push(Jv(q, f, d));
    ...
    function Dv(a) {
        var b = uv(a), c = b, d = [c.Z.x, c.Z.y];
        do c = vv(a), c.Z.x > d[0] && (d = [c.Z.x, c.Z.y]); while (c !== b);
        return d
    }

    function Ev(a, b, c) {
        var d = uv(a), e = d, f = vv(a), g = !1;
        do {
            var h = c ? Du(f.X.x, f.X.y, e.X.x, e.X.y, e.Z.x, e.Z.y) : Du(e.Z.x, e.Z.y, e.X.x, e.X.y, f.X.x, f.X.y);
            void 0 === h ? (Kv(e, f, a, b), g = !0, f === d && (d = wv(a)), f = e, xv(a)) : e.X.Hb !== h && (e.X.Hb = h, g = !0);
            e = f;
            f = vv(a)
        } while (e !== d);
        return g
    ...
    function Gv(a, b, c, d, e) {
        for (var f = uv(a); f.X.x !== b;) f = vv(a);
        b = f.X;
        d = {x: d, y: b.y, mb: -1};
        var g = Infinity, h;
        var l = Fv({Z: b, X: d}, e, !0);
        var m = 0;
        for (h = l.length; m < h; ++m) {
            var n = l[m], p = Lv(b, d, n.Z, n.X, !0), q = Math.abs(b.x - p[0]);
        ...
        l = f.X;
        if (0 < g && (f = Mv(b, r, f.X, e), f.length)) for (r = Infinity, m = 0, h = f.length; m < h; ++m) if (g = f[m], n = Math.atan2(b.y - g.y, d.x - g.x), n < r || n === r && g.x < l.x) r = n, l = g;
        for (f = uv(c); f.X.x !== l.x || f.X.y !==
        l.y;) f = vv(c);
        d = {x: b.x, y: b.y, mb: b.mb, Hb: void 0};
        m = {x: f.X.x, y: f.X.y, mb: f.X.mb, Hb: void 0};
        wv(a).Z = d;
        Jv(b, f.X, a, e);
        Jv(m, d, a, e);
        f.X = m;
        a.i && a.b && (a.f = a.b, a.a = a.b.Bb);
        c.concat(a);
        return !0
    }

    function Hv(a, b, c) {
        for (var d = !1, e = Nv(b, c); 3 < b.c;) if (e) {
            if (!Ov(a, b, c, e, d) && !Ev(b, c, d) && !Pv(a, b, c, !0)) break
        } else if (!Ov(a, b, c, e, d) && !Ev(b, c, d) && !Pv(a, b, c)) if (e = Nv(b, c)) {
            d = b;
            var f = 2 * d.c, g = Array(f), h = uv(d), l = h, m = 0;
            do g[m++] = l.Z.x, g[m++] = l.Z.y, l = vv(d); while (l !== h);
            d = !Kf(g, 0, f, 2);
            Ev(b, c, d)
        } else {
            e = a;
            ...
            do {
                ...
                if (h.length) {
                    ...
                    Jv(h, f.X, l, m);
                    f.X = h;
                    Os(c, [Math.min(f.Z.x, h.x), Math.min(f.Z.y, h.y), Math.max(f.Z.x, h.x), Math.max(f.Z.y,
                        h.y)], f);
                    for (f = vv(d); f !== g;) Jv(f.Z, f.X, l, m), c.remove(f), tv(d), f = zv(d);
                    Jv(g.Z, h, l, m);
                    g.Z = h;
        ...
        3 === b.c && (e = a.b.length, a.b[e++] = yv(b).Z.mb, a.b[e++] = zv(b).Z.mb, a.b[e++] = wv(b).Z.mb)
    }

    function Ov(a, b, c, d, e) {
        var f = a.b.length, g = uv(b), h = yv(b), l = g, m = vv(b), n = wv(b), p = !1;
        do {
            var q = l.Z;
            var r = l.X;
            var u = m.X;
            if (!1 === r.Hb) {
                ...
                !d && 0 !== Fv({
                    Z: q,
                    X: u
                }, c).length || !x || !d && !1 !== q.Hb && !1 !== u.Hb && Kf([h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y], 0, 10, 2) !== !e || (a.b[f++] = q.mb, a.b[f++] = r.mb, a.b[f++] = u.mb, Kv(l, m, b, c), m === g && (g = n), p = !0)
            }
            h = yv(b);
            l = zv(b);
            m = vv(b);
    ...
    function Pv(a, b, c, d) {
        ...
        do {
            ...
            if (l) {
                h = a.b.length;
                var m = a.a.length / 2, n = xv(b);
                tv(b);
                c.remove(n);
                var p = n === e;
                d ? (l[0] === f.Z.x && l[1] === f.Z.y ? (xv(b), l = f.Z, g.Z = l, c.remove(f), p = p || f === e) : (l = g.X, f.X = l, c.remove(g), p = p || g === e), tv(b)) : (l = Iv(a, l[0], l[1], m), f.X = l, g.Z = l, Os(c, [Math.min(f.Z.x, f.X.x), Math.min(f.Z.y, f.X.y), Math.max(f.Z.x, f.X.x), Math.max(f.Z.y, f.X.y)], f), Os(c, [Math.min(g.Z.x, g.X.x), Math.min(g.Z.y, g.X.y), Math.max(g.Z.x, g.X.x), Math.max(g.Z.y,
                    g.X.y)], g));
                a.b[h++] = n.Z.mb;
                a.b[h++] = n.X.mb;
                a.b[h++] = l.mb;
    ...
    function Iv(a, b, c, d) {
        ...
        a.a[e++] = b;
        a.a[e++] = c;
        return {x: b, y: c, mb: d, Hb: void 0}
    }

    function Jv(a, b, c, d) {
        var e = {Z: a, X: b}, f = {Bb: void 0, next: void 0, data: e}, g = c.b;
        if (g) {
            var h = g.next;
            f.Bb = g;
            f.next = h;
            ...
            h && (h.Bb = f);
            g === c.a && (c.a = f)
        } else c.f = f, c.a = f, c.i && (f.next = f, f.Bb = f);
        c.b = f;
        c.c++;
    ...
    function Kv(a, b, c, d) {
        zv(c) === b && (tv(c), a.X = b.X, d.remove(b), Os(d, [Math.min(a.Z.x, a.X.x), Math.min(a.Z.y, a.X.y), Math.max(a.Z.x, a.X.x), Math.max(a.Z.y, a.X.y)], a))
    }

    function Mv(a, b, c, d, e) {
        var f, g, h = [],
            l = Qs(d, [Math.min(a.x, b.x, c.x), Math.min(a.y, b.y, c.y), Math.max(a.x, b.x, c.x), Math.max(a.y, b.y, c.y)]);
        d = 0;
    ...
    function Lv(a, b, c, d, e) {
        ...
        if (0 !== f && (d = ((d.x - c.x) * (a.y - c.y) - (d.y - c.y) * (a.x - c.x)) / f, c = ((b.x - a.x) * (a.y - c.y) - (b.y - a.y) * (a.x - c.x)) / f, !e && d > Eu && d < 1 - Eu && c > Eu && c < 1 - Eu || e && 0 <= d && 1 >= d && 0 <= c && 1 >= c)) return [a.x + d * (b.x - a.x), a.y + d * (b.y - a.y)]
    }

    function Qv(a, b, c, d, e) {
        if (void 0 === b.Hb || void 0 === d.Hb) return !1;
    ...
    k = Av.prototype;
    k.tc = function (a, b) {
        var c = a.md(), d = a.pa(), e = this.b.length, f = this.g.b.length;
        a = a.ca();
        var g, h, l;
        var m = h = 0;
        ...
        this.b.length > e && (this.f.push(e), this.i.push(b), this.l.u && (this.c.push(e), this.l.u = !1));
        this.g.b.length > f && nv(this.g,
            b, f)
    };
    k.vc = function (a, b) {
        var c = a.lb(), d = a.pa();
    ...
    k.Ab = function (a) {
        var b = this.o, c = this.j, d = this.g.Ab(a);
        return function () {
            Iu(a, b);
            Iu(a, c);
            d()
    ...
    k.Bf = function (a, b) {
        var c = Ju(b, pv, qv);
        if (this.v) var d = this.v; else this.v = d = new rv(a, c);
        b.Wc(c);
        a.enableVertexAttribArray(d.b);
    ...
    k.La = function (a, b) {
        ...
        b ? this.g.La(null, b) : this.g.La(null, new Dk({color: [0, 0, 0, 0], lineWidth: 0}))
    };
    ...
    Rv.prototype.add = function (a, b, c, d, e) {
        ...
        for (f = this.a.length; g < f; ++g) {
            ...
            if (h.width >= b + this.b && h.height >= c + this.b) return f = {
                ...
                width: h.width - b,
                height: h.height
            }, b = {x: h.x, y: h.y + d, width: b, height: h.height - d}, Sv(this, a, c, b)) : (c = {
                x: h.x + b,
                y: h.y,
                width: h.width - b,
                height: d
    ...
    function Vv(a, b) {
        return {offsetX: a.offsetX, offsetY: a.offsetY, image: a.image, hm: b.image}
    }
    ...
    function Wv(a, b, c, d, e, f, g) {
        ...
        for (l = h.length; m < l; ++m) {
            ...
            n || m !== l - 1 || (b ? (n = Math.min(2 * a.c, a.f), a.c = n) : (n = Math.min(2 * a.a, a.f), a.a = n), n = new Rv(n, a.b), h.push(n), ++l)
        }
        return null
    }
    function Xv(a, b) {
    ...
    k.Sb = function (a, b) {
        if (this.qa) {
            ...
            a = this.l;
            b = this.qa.split("\n");
            var f = Yv(this, b), g, h, l = Math.round(f[0] * this.kb - this.ta),
                m = Math.round(f[1] * this.ma - this.fa), n = this.O.lineWidth / 2 * this.O.scale;
            f = 0;
            for (g = b.length; f < g; ++f) {
                ...
                for (h = r.length; u < h; ++u) {
                    var x = a.yh;
                    var B = r[u], A = Uv(x.g, B);
                    A ? (x = Uv(x.i, B), x = Vv(A, x)) : x = null;
                    if (x) {
                        A = x.image;
                        this.C = l - p;
                        this.D = m - q;
    ...
    function Zv(a, b) {
        if (1 === b.length) {
            ...
            c.yh.add(b, a, c.height, function (a, c, g) {
                ...
                a.textAlign = "left";
                a.textBaseline = "top";
                qd && d.lineDash && (a.setLineDash(d.lineDash), a.lineDashOffset = d.lineDashOffset);
    ...
    k.ib = function (a) {
        ...
        if (a && a.Ia() && (c || d)) {
            c ? (c = c.b, b.fillColor = Th(c ? c : Au)) : b.fillColor = null;
            d ? (c = d.b, b.strokeColor = Th(c ? c : Cu), b.lineWidth = d.c || 1, b.lineCap = d.g || "round", b.lineDashOffset = d.i || 0, b.lineJoin = d.j || "round", b.miterLimit = d.l || 10, d = d.f, b.lineDash = d ? d.slice() : Bu) : (b.strokeColor = null, b.lineWidth = 0);
            ...
            e = c;
            this.B[e] || (a = this.oc.getContext("2d"), a.font = b.font, a = Math.ceil((1.5 * a.measureText("M").width + b.lineWidth / 2) * b.scale), this.B[e] = {
                yh: new Tv({space: b.lineWidth + 1}),
                width: {},
                height: a
            });
            this.l = this.B[e]
    ...
    $v.prototype.b = function (a, b) {
        ...
        c = a[b];
        void 0 === c && (c = new cw[b](this.j, this.g), a[b] = c);
        return c
    };
    ...
    function dw(a, b, c, d, e, f, g, h, l, m, n) {
        var p = ew, q = Object.keys(a.f).map(Number);
        q.sort(function (a, b) {
            return b - a
        });
        var r, u;
    ...
    var ew = [1, 1], cw = {Circle: Hu, Image: Xu, LineString: av, Polygon: Av, Text: Xv};
    ...
    k.uc = function (a, b) {
        var c = this.b, d = new $v(1, this.c), e = d.b(0, "Image");
        e.Wb(this.s);
        e.uc(a, b);
        e.$a(c);
    ...
    k.qc = function (a, b) {
        var c = this.b, d = new $v(1, this.c), e = d.b(0, "LineString");
        e.La(null, this.o);
        e.qc(a, b);
        e.$a(c);
        e.Ka(this.b, this.f, this.g, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    k.vc = function (a, b) {
        var c = this.b, d = new $v(1, this.c), e = d.b(0, "Polygon");
        e.La(this.v, this.o);
        e.vc(a, b);
        e.$a(c);
        e.Ka(this.b, this.f, this.g, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    k.$b = function (a, b) {
        var c = this.b, d = new $v(1, this.c), e = d.b(0, "Circle");
        e.La(this.v, this.o);
        e.$b(a, b);
        e.$a(c);
        e.Ka(this.b, this.f, this.g, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    lw.prototype.Ti = function (a, b, c) {
        ...
        yu(c, 34962, this.U);
        var d = c.b, e = Ju(c, iw, jw);
        if (this.s) var f = this.s; else this.s = f = new kw(d, e);
        c.Wc(e) && (d.enableVertexAttribArray(f.b), d.vertexAttribPointer(f.b, 2, 5126, !1, 16, 0), d.enableVertexAttribArray(f.a), d.vertexAttribPointer(f.a, 2, 5126, !1, 16, 8), d.uniform1i(f.i, 0));
    ...
    function qw(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        var r = dg(Math.round(c * lb(q) / d), Math.round(c * mb(q) / d)), u = c / d;
        l.forEach(function (a) {
        ...
        h.c.forEach(function (a) {
            ...
            g && (p.save(), p.beginPath(), l = (a + u + U) / 3, m = (n + B + Xb) / 3, h = pw(l, m, a, n), u = pw(l, m, u, B), U = pw(l, m, U, Xb), p.moveTo(u[0], u[1]), p.lineTo(h[0], h[1]), p.lineTo(U[0], U[1]), p.clip(), p.transform(g[0], g[2], g[1], g[3], a, n), p.translate(q[0] - e, q[3] - b), p.scale(d / c, -d / c), p.drawImage(r.canvas, 0, 0), p.restore())
        });
    ...
    function sw(a, b, c, d, e, f, g, h, l, m) {
        var n = Oa([f, g, h, l]), p = a.b ? lb(n) / a.b : null, q = a.b, r = a.f.f && .5 < p && 1 > p, u = !1;
        if (0 < m) {
            if (a.i.c && a.j) {
                var x = Oa([b, c, d, e]);
                u |= .25 < lb(x) / a.j
        ...
        if (u || !a.g || qb(n, a.g)) {
            ...
            if (0 < m && (u || (n = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2]), q = r ? (Ja(f[0], q) + Ja(h[0], q)) / 2 - Ja(n[0], q) : (f[0] + h[0]) / 2 - n[0], n = (f[1] + h[1]) / 2 - n[1],
                    u = q * q + n * n > a.v), u)) {
                Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1]) ? (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], q = a.a(r), n = [(e[0] + b[0]) / 2, (e[1] + b[1]) / 2], p = a.a(n), sw(a, b, c, r, n, f, g, q, p, m - 1), sw(a, n, r, d, e, p, q, h, l, m - 1)) : (r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2], q = a.a(r), n = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2], p = a.a(n), sw(a, b, r, n, e, f, q, p, l, m - 1), sw(a, r, c, d, n, q, g, h, p, m - 1));
                return
            }
            if (r) {
                if (!a.o) return;
    ...
    function uw(a, b, c, d, e, f) {
        ...
        e = 2;
        f = [];
        this.Jb && (e = 0, f = this.Jb.c);
        ps.call(this, c, d, this.l, e, f)
    }

    v(uw, ps);
    uw.prototype.ka = function () {
        1 == this.state && (Hc(this.me), this.me = null);
    ...
    uw.prototype.load = function () {
        if (0 == this.state) {
            ...
            2 == a || 3 == a ? this.je() : (this.me = z(this.Jb, "change", function () {
                var a = this.Jb.getState();
                if (2 == a || 3 == a) Hc(this.me), this.me = null, this.je()
            }, this), this.Jb.load())
        }
    };
    ...
    vw.prototype.Y = function (a, b, c, d) {
        ...
        if (e && d && !hc(e, d)) {
            if (this.i) {
                if (this.fa == this.f && hc(this.i.v, d) && this.i.resolution == b && cb(this.i.G(), a)) return this.i;
                Qc(this.i);
                this.i = null
            }
    ...
    v(xw, Rc);
    var yw = "imageloadstart", zw = "imageloadend", Aw = "imageloaderror";
    ...
    Cw.prototype.Qc = function (a, b, c, d) {
        b = ww(this, b);
        var e = this.T;
        if (e && this.U == this.f && e.resolution == b && e.a == c && Wa(e.G(), a)) return e;
        a = a.slice();
        rb(a, this.oa);
        ...
        this.a.ac(a, function (a) {
            ...
            if (!(d = g)) {
                ...
                if (e) {
                    ...
                    Array.isArray(e) || (e = [e]);
                    d = 0;
                    for (h = e.length; d < h; ++d) p = xj(f, a, e[d], wj(b, c), this.yo, this) || p;
                    d = p
                } else d = !1
            }
            g = d
    ...
    Fw.prototype.zg = function (a, b) {
        var c = this.c.f, d = a.pixelRatio, e = a.viewState, f = e.center, g = e.resolution, h = e.rotation, l = this.N,
            m = this.Kb, n = this.a.ia(), p = a.viewHints, q = a.extent;
        void 0 !== b.extent && (q = pb(q, b.extent));
        p[0] || p[1] || kb(q) || (b = n.Y(q, g, d, e.projection)) && ii(this, b) && (l = b, m = Gw(this, b), this.Kb && a.postRenderFunctions.push(function (a, b) {
            a.isContextLost() || a.deleteTexture(b)
        }.bind(null, c, this.Kb)));
        l && (c = this.c.getContext().j, Hw(this, c.width, c.height, d, f, g, h, l.G()), this.l = null, d = this.v, Ve(d), af(d, 1,
            -1), bf(d, 0, -1), this.N = l, this.Kb = m, ki(a.attributions, l.c), li(a, n));
        return !!l
    };
    ...
    Fw.prototype.xg = function (a, b, c, d) {
        if (this.N && this.N.Y()) if (this.a.ia() instanceof Dw) {
            var e = Ze(b.pixelToCoordinateTransform, a.slice());
            if (this.Fa(e, b, 0, Pe, this)) return c.call(d, this.a, null)
        } else {
            ...
            if (!(0 > a[0] || a[0] > e[0] || 0 > a[1] || a[1] > e[1]) && (this.i ||
                (this.i = dg(1, 1)), this.i.clearRect(0, 0, 1, 1), this.i.drawImage(this.N.Y(), a[0], a[1], 1, 1, 0, 0, 1, 1), e = this.i.getImageData(0, 0, 1, 1).data, 0 < e[3])) return c.call(d, this.a, e)
        }
    };
    ...
    function Jw(a, b, c, d) {
        var e = a.f, f = b.gb();
        if (a.a.b.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Kb), 9729 != a.ei && (e.texParameteri(3553, 10240, 9729), a.ei = 9729), 9729 != a.gi && (e.texParameteri(3553, 10241, 9729), a.gi = 9729); else {
            ...
            a.a.set(f, {Kb: g, ei: 9729, gi: 9729})
        }
    }
    ...
    k.Ik = function (a, b) {
        ...
        for (var c; 1024 < this.a.c - this.i;) {
            if (c = this.a.a.Hc) a.deleteTexture(c.Kb); else if (+this.a.a.fc == b.index) break; else --this.i;
            this.a.pop()
        }
    };
    ...
    k.$g = function (a) {
        ...
        h = 0;
        for (g = d.length; h < g; ++h) l = d[h], m = Di(this, l.layer), m.Ti(a, l, b);
        this.l || (this.b.style.display = "", this.l = !0);
        Bi(a);
        1024 < this.a.c - this.i && a.postRenderFunctions.push(this.Ik.bind(this));
        0 !== this.g.b.length && (a.postRenderFunctions.push(this.B), a.animate = !0);
    ...
    k.Fa = function (a, b, c, d, e, f, g) {
        ...
        for (m = l.length - 1; 0 <= m; --m) {
            var n = l[m];
            var p = n.layer;
            if (xi(n, h.resolution) && f.call(g, p) && (n = Di(this, p).Fa(a, b, c, d, e))) return n
        }
    };
    k.Ri = function (a, b, c, d, e) {
        c = !1;
        ...
        for (h = g.length - 1; 0 <= h; --h) {
            var l = g[h], m = l.layer;
            if (xi(l, f.resolution) && d.call(e, m) && (c = Di(this, m).df(a, b))) return !0
        }
        return c
    };
    k.Qi = function (a, b, c, d, e) {
        ...
        for (h = g.length - 1; 0 <= h; --h) {
            var l = g[h];
            var m = l.layer;
            if (xi(l, f.resolution) && e.call(d, m) && (l = Di(this, m).xg(a, b, c, d))) return l
        }
    };
    ...
    k.zg = function (a, b, c) {
        var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ia(), m = l.Xa(g),
            n = m.xc(f.resolution), p = m.Qa(n), q = l.be(n, a.pixelRatio, g), r = q[0] / Na(m.eb(n), this.T)[0],
            u = p / r, x = l.Sc(r) * l.$f(g), B = f.center, A = a.extent, y = tc(m, A, n);
        if (this.l && Aa(this.l, y) && this.o == l.f) u = this.C; else {
            ...
            var Cb;
            ra = 0;
            for (T = b.length; ra < T; ++ra) for (Cb in U = c[b[ra]], U) la = U[Cb], Ca = m.Ja(la.wa, fa), va[0] = 2 * (Ca[2] - Ca[0]) / N, va[1] = 2 * (Ca[3] - Ca[1]) / N, va[2] = 2 * (Ca[0] - u[0]) / N - 1, va[3] = 2 * (Ca[1] - u[1]) / N -
                1, e.uniform4fv(this.i.c, va), Jw(d, la, q, x * r), e.drawArrays(5, 0, 4);
            ca ? (this.l = y, this.C = u, this.o = l.f) : (this.C = this.l = null, this.o = -1, a.animate = !0)
        }
        ...
        af(e, a.size[0] * f.resolution / (u[2] -
    ...
    k.Ti = function (a, b, c) {
        ...
        e && !e.c() && (h.enable(h.SCISSOR_TEST), h.scissor(0, 0, f[0] * g, f[1] * g), e.Ka(c, d.center, d.resolution, d.rotation, f, g, b.opacity, b.Ue ? a.skippedFeatureUids : {}), h.disable(h.SCISSOR_TEST))
    };
    k.ka = function () {
        var a = this.i;
        if (a) {
    ...
    k.xg = function (a, b, c, d) {
        a = Ze(b.pixelToCoordinateTransform, a.slice());
        if (this.df(a, b)) return c.call(d, this.a, null)
    };
    k.Ui = function () {
        hi(this)
    };
    k.zg = function (a, b, c) {
        function d(a) {
            ...
            if (c) {
                if (c) {
                    b = !1;
                    if (Array.isArray(c)) for (var d = c.length - 1; 0 <= d; --d) b = xj(q, a, c[d], wj(m, n), this.Ui, this) || b; else b = xj(q, a, c, wj(m, n), this.Ui, this) || b;
                    a = b
                } else a = !1;
                this.o = this.o || a
            }
        ...
        li(a, b);
        var f = a.viewHints[0], g = a.viewHints[1], h = e.U, l = e.ta;
    ...
    function Sw(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        e = this.c.G();
        f = h ? pb(f, h) : f;
        if (0 === jb(f)) this.state = 4; else if ((h = a.G()) && (e ? e = pb(e, h) : e = h), d = ow(a, c, nb(f), d.Qa(this.v[0])), !isFinite(d) || 0 >= d) this.state = 4; else if (this.s = new rw(a, c, f, e, d * (void 0 !== m ? m : .5)), 0 === this.s.c.length) this.state = 4; else if (this.g = b.xc(d), c = tw(this.s), e && (a.f ? (c[1] = Da(c[1], e[1], e[3]),
                c[3] = Da(c[3], e[1], e[3])) : c = pb(c, e)), jb(c)) {
            a = tc(b, c, this.g);
            for (b = a.ba; b <= a.da; b++) for (c = a.ea; c <= a.ga; c++) (m = l(this.g, b, c, g)) && this.a.push(m);
    ...
    Sw.prototype.ka = function () {
        1 == this.state && (this.Fd.forEach(Hc), this.Fd = null);
        ss.prototype.ka.call(this)
    };
    ...
    Sw.prototype.je = function () {
        ...
        this.a.forEach(function (b) {
            b && 2 == b.getState() && a.push({extent: this.c.Ja(b.wa), image: b.Y()})
        }, this);
        this.a.length = 0;
        if (0 === a.length) this.state = 3; else {
            ...
            b = this.l.Qa(b);
            var e = this.c.Qa(this.g), f = this.l.Ja(this.v);
            ...
            this.a.forEach(function (b) {
                ...
                if (0 == c || 1 == c) {
                    ...
                    var d = z(b, "change", function () {
                        var c = b.getState();
                        if (2 == c || 3 == c || 4 == c) Hc(d), a--, 0 === a && (this.Fd.forEach(Hc), this.Fd = null, this.je())
                    }, this);
                    this.Fd.push(d)
                }
            }, this);
    ...
    function Uw(a, b) {
        for (var c = a.length, d = Array(c), e = 0; e < c; ++e) d[e] = Tw(a[e], b);
        return Vw(d)
    }
    ...
    Yw.prototype.ld = function (a) {
        for (var b, c; gj(this);) {
            ...
            c = b.wa[0].toString();
            var d;
            if (d = c in a) b = b.wa, d = za(a[c], b[1], b[2]);
    ...
    function $w(a) {
        ...
        this.l = [0, 0];
        this.fc = "";
        this.ma = {transition: a.transition}
    }
    ...
    function gi(a, b, c, d, e) {
        ...
        if (!a) return !1;
        b = !0;
        for (var f, g, h = d.ba; h <= d.da; ++h) for (var l = d.ea; l <= d.ga; ++l) f = c + "/" + h + "/" + l, g = !1, a.b.hasOwnProperty(f) && (f = a.get(f), (g = 2 === f.getState()) && (g = !1 !== e(f))), g || (b = !1);
        return b
    }
    ...
    function bx(a, b, c) {
        ...
        if (a.C && d.c) {
            ...
            a = yc(c, e);
            d = Dc(d);
            Ua(d, a) ? b = e : (e = lb(d), a[0] += e * Math.ceil((d[0] - a[0]) / e), b = c.kg(a, b))
        }
        e = b[0];
        d = b[1];
        a = b[2];
    ...
    k.Uc = function (a, b, c, d, e) {
        if (this.c && e && !hc(this.c, e)) {
            ...
            d.key = b;
            g ? (d.f = g, ts(d), f.replace(a, d)) : f.set(a, d);
            return d
        }
    ...
    function hx(a, b, c, d, e, f) {
        ...
        } else l = gx(a, b, c, d, e, f, h), a.a.set(g, l);
        return l
    }
    ...
    function ix(a) {
        ...
        this.o = a.key;
        this.s = a.imagerySet;
        Rw("https://dev.virtualearth.net/REST/v1/Imagery/Metadata/" +
            this.s + "?uriScheme=https&include=ImageryProviders&key=" + this.o, this.Va.bind(this), void 0, "jsonp")
    }

    v(ix, ex);
    var jx = new Fc({html: '<a class="ol-attribution-bing-tos" href="https://www.microsoft.com/maps/product/terms.html">Terms of Use</a>'});
    ...
    ix.prototype.Va = function (a) {
        if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) Ms(this, "error"); else {
    ...
    k.ce = function (a, b, c) {
        ...
        b !== this.resolution && (this.clear(), this.resolution = b, ox(this), this.Ic(this.features))
    };
    k.$p = function (a) {
        this.distance = a;
        this.ua()
    ...
    function ox(a) {
        if (void 0 !== a.resolution) {
            ...
            for (var b = Pa(), c = a.distance * a.resolution, d = a.source.fe(), e = {}, f = 0, g = d.length; f < g; f++) {
                var h = d[f];
                w(h).toString() in e || !(h = a.geometryFunction(h)) || (h = h.V(), $a(h, b), Ra(b, c, b), h = a.source.Zf(b), h = h.filter(function (a) {
                    a = w(a).toString();
    ...
    k.Qc = function (a, b, c, d) {
        ...
        c = this.U ? c : 1;
        var e = this.N;
        if (e && this.I == this.f && e.resolution == b && e.a == c && Wa(e.G(), a)) return e;
    ...
    function sx(a) {
        vw.call(this, {projection: a.projection, resolutions: a.resolutions});
        this.T = void 0 !== a.crossOrigin ? a.crossOrigin : null;
    ...
    k.Qc = function (a, b, c) {
        ...
        c = this.U ? c : 1;
        var d = this.N;
        if (d && this.B == this.f && d.resolution == b && d.a == c && Wa(d.G(), a)) return d;
        1 != this.v && (a = a.slice(), rb(a, this.v));
        var e = [lb(a) / b * c, mb(a) / b * c];
        if (void 0 !== this.I) {
            d = this.I;
            var f = nb(a), g = this.ma, h = lb(a), l = mb(a), m = e[0], n = e[1], p = .0254 / this.o;
            e = {
    ...
    function tx(a) {
        ...
        vw.call(this, {attributions: a.attributions, logo: a.logo, projection: Zb(a.projection)});
    ...
    k.Qc = function (a, b, c, d) {
        ...
        if ((f = this.N) && this.T == this.f && f.resolution == b && f.a == c && Wa(f.G(), g)) return f;
    ...
    k.Fo = function (a) {
        a != this.g && (this.g = a, this.N = null, this.u())
    };
    k.Go = function (a) {
        tb(this.a, a);
        vx(this);
    ...
    v(yx, kx);
    var zx = new Fc({html: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors.'});
    Op.nf = {};
    Op.nf.Hf = function () {
    };
    (function (a) {
        ...
        function f(a) {
            ...
            var c = [];
            if (b) for (var f = 0; f < b; ++f) c[f] = d(a, this.vh.bind(this, f)); else c[0] = e(a, this.vh.bind(this,
                0));
            this.ze = c;
            this.Kd = [];
        ...
        f.prototype.xp = function (a, b, c) {
            this.rk({inputs: a, fi: b, callback: c});
            this.sh()
        };
        f.prototype.rk = function (a) {
            for (this.Kd.push(a); this.Kd.length > this.tk;) this.Kd.shift().callback(null, null)
        };
        f.prototype.sh = function () {
            if (0 === this.ye && 0 < this.Kd.length) {
                var a = this.Kf = this.Kd.shift(), b = a.inputs[0].width, c = a.inputs[0].height,
                    d = a.inputs.map(function (a) {
                        return a.data.buffer
                    }), e = this.ze.length;
                this.ye = e;
                if (1 === e) this.ze[0].postMessage({
                    buffers: d,
                    meta: a.fi,
                    imageOps: this.Jf,
                    width: b,
                    ...
                    this.ze[g].postMessage({buffers: B, meta: a.fi, imageOps: this.Jf, width: b, height: c}, B)
                }
            }
        };
        f.prototype.vh = function (a, b) {
            this.Mq || (this.hd[a] = b.data, --this.ye, 0 === this.ye && this.uk())
        };
        f.prototype.uk = function () {
            var a =
                this.Kf, c = this.ze.length;
            if (1 === c) {
    ...
    function Ax(a) {
        ...
        this.g = Bx(a.sources);
        for (var b = 0, c = this.g.length; b < c; ++b) z(this.g[b], "change", this.u, this);
    ...
    Ax.prototype.v = function (a, b) {
        this.B = new Op.nf.Hf({operation: a, im: "image" === this.oa, zp: 1, lib: b, threads: this.Va});
        this.u()
    };
    ...
    Ax.prototype.ma = function (a, b, c, d) {
        if (!b && c) {
            ...
            if (e === this.o.viewState.resolution && cb(b, this.o.extent)) {
                if (this.a) var f = this.a.Y().getContext("2d"); else f = dg(Math.round(lb(b) / e), Math.round(mb(b) / e)), this.a = new rs(b, e, 1, this.j, f.canvas);
    ...
    function Bx(a) {
        for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
            ...
            f instanceof $w ? (f = new ou({source: f}), g = new Hi(f)) : f instanceof vw && (f = new nu({source: f}), g = new vi(f));
            c[e] = g
        }
        return c
    }
    ...
    var Fx = "beforeoperations", Gx = "afteroperations";
    ...
    v(Hx, kx);
    var Kx = [new Fc({html: 'Map tiles by <a href="https://stamen.com/">Stamen Design</a>, under <a href="https://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>.'}), zx],
        Jx = {
            terrain: {Nb: "jpg", opaque: !0},
            "terrain-background": {Nb: "jpg", opaque: !0},
            "terrain-labels": {Nb: "png", opaque: !1},
            "terrain-lines": {Nb: "png", opaque: !1},
            "toner-background": {Nb: "png", opaque: !0},
            toner: {Nb: "png", opaque: !0},
            "toner-hybrid": {Nb: "png", opaque: !1},
            "toner-labels": {Nb: "png", opaque: !1},
            "toner-lines": {Nb: "png", opaque: !1},
            "toner-lite": {
                Nb: "png",
                opaque: !0
            },
            watercolor: {Nb: "jpg", opaque: !0}
        }, Ix = {
    ...
    function Px(a) {
        ...
        if (a.url) if (a.jsonp) Rw(a.url, this.Ag.bind(this), this.ef.bind(this)); else {
            var b = new XMLHttpRequest;
            b.addEventListener("load", this.Io.bind(this));
            b.addEventListener("error", this.Ho.bind(this));
            b.open("GET", a.url);
            b.send()
        } else a.tileJSON ? this.Ag(a.tileJSON) : wa(!1, 51)
    }
    ...
    function Qx(a) {
        ...
        this.g = void 0;
        this.i = a.jsonp || !1;
        if (a.url) if (this.i) Rw(a.url, this.Bg.bind(this), this.ff.bind(this)); else {
            var b = new XMLHttpRequest;
    ...
    k.Kk = function (a, b, c, d, e) {
        this.tileGrid ? (b = this.tileGrid.Me(a, b), Rx(this.Uc(b[0], b[1], b[2], 1, this.c), a, c, d, e)) : !0 === e ? setTimeout(function () {
            c.call(d, null)
        }, 0) : c.call(d, null)
    };
    k.ff = function () {
    ...
    function Rx(a, b, c, d, e) {
        ...
        }, a), Tx(a)) : !0 === e ? setTimeout(function () {
            c.call(d, this.getData(b))
    ...
    function Tx(a) {
        if (0 == a.state) if (a.state = 1, a.s) Rw(a.v, a.Wi.bind(a), a.Oe.bind(a)); else {
            var b = new XMLHttpRequest;
    ...
    k.No = function (a, b, c, d) {
        ...
        b = e.Me(a, b);
        if (!(e.b.length <= b[0])) {
            var f = e.Qa(b[0]), g = e.Ja(b, this.fa);
    ...
    function Xx(a, b, c, d, e, f, g) {
        ...
        if (h) {
            ...
            g.BBOX = d.join(",");
            return qx(1 == h.length ? h[0] : h[Ja((b[1] <<
                b[0]) + b[2], h.length)], g)
        }
    }
    ...
    k.Lc = function (a, b, c) {
        ...
        if (!(d.b.length <= a[0])) {
            ...
            var e = d.Qa(a[0]), f = d.Ja(a, this.fa);
    ...
    function Fj(a, b) {
        b = w(b).toString();
        b in a.v || (a.v[b] = {Ee: !1, bh: null, wf: -1, dh: -1});
        return a.v[b]
    }
    ...
    k.Hh = function () {
        ...
        a == this.a.length ? (this.g.forEach(Hc), this.g.length = 0, Ji(this, 2)) : Ji(this, b == this.a.length ? 4 : 3)
    };
    ...
    k.load = function () {
        0 == this.state && (Ji(this, 1), this.D(this, this.O), this.C(null, NaN, null))
    };
    k.ip = function (a, b, c) {
        this.ug(b);
        this.Aj(a);
    ...
    k.Xa = function (a) {
        var b = a.sb, c = this.g[b];
        c || (c = this.tileGrid, c = this.g[b] = Ac(a, void 0, c ? c.eb(c.minZoom) : void 0));
        return c
    };
    k.Sc = function (a) {
        return a
    ...
    function dy(a, b, c) {
        ...
        var m = c.Rc(), n = "ne" == c.b.substr(0, 2);
    ...
    function Z(a) {
        ...
        "KVP" == d && tb(f, {Service: "WMTS", Request: "GetTile", Version: this.oa, Format: this.s});
        var g = this.i, h = c && 0 < c.length ? Vw(c.map(b)) : Ww;
        ex.call(this, {
            attributions: a.attributions,
            cacheSize: a.cacheSize,
            crossOrigin: a.crossOrigin,
